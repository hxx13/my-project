...
Page({
  ...
  onShow() {
    ...
    if (!pagePermission.guardPageOnShow(this, '/package-door/pages/dahuaIssue/index', role, 'ADMIN')) {
      return;
    }
  ...
  /** 移动端「房间自助进入」灰度配置：与 Web 端 dahua-issue 右上角「更多操作」同一功能，独立成页 */
  goMobileEnter() {
    wx.navigateTo({ url: '/package-door/pages/mobileEnter/index' });
  },
