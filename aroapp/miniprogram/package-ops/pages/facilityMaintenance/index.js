...
Page({
  ...
  onShow() {
    ...
    if (!pagePermission.guardPageOnShow(this, '/package-ops/pages/facilityMaintenance/index', role, 'STAFF')) return;
  ...
  goHistory() {
    wx.navigateTo({ url: '/package-ops/pages/facilityMaintenance/historyInsp' });
  },

  goSettings() {
    wx.navigateTo({ url: '/package-ops/pages/facilityMaintenance/settings' });
  },
