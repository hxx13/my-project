...
Page({
  ...
  onShow() {
    ...
    if (!pagePermission.guardPageOnShow(this, '/package-supplies/pages/suppliesProcess/index', role, 'SUPER_ADMIN')) return;
  ...
  goReviseInMall(e) {
    ...
    wx.navigateTo({ url: `/package-supplies/pages/supplies/index?reviseClaimId=${encodeURIComponent(id)}` });
    this.collapseOne(id);
  },
