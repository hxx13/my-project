...
function canShowStudentMaterialSwitch(role) {
  ...
  return pagePermission.canShowMiniEntry('mine', '/package-student/pages/studentMaterial/index', role || 'STUDENT', 'STUDENT');
}
...
function resolveSuppliesUrl(role) {
  ...
  const minePath = '/package-supplies/pages/suppliesMine/index';
...
function goStudentMaterial() {
  ...
  wx.redirectTo({ url: '/package-student/pages/studentMaterial/index' });
}
