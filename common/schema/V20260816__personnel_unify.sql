-- 归档迁移，与 db/bootstrap-personnel-unify.sql 同源。
-- 统一人员资料库：院校字典 + 课题组字典 + sys_user 加资料字段。
-- 幂等：CREATE TABLE IF NOT EXISTS + 逐列 information_schema 检查。
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='统一人员表（姓名唯一主键 + 双 id 识别）';
