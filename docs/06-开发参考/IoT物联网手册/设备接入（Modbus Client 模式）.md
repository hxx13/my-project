...
-   [《设备接入（Modbus Server）》](/开发参考/IoT物联网手册/设备接入（Modbus Server 模式）.md)
-   《阿里云物联网 —— 添加 Modbus 协议设备》

Modbus Client 协议接入，由 `yudao-module-iot-gateway` 模块的 `protocol.modbus.tcpclient` 包实现，基于 j2mod 库，默认端口 502。
    ...
    gateway:
      protocols:
        - id: modbus-tcp-client-1
          enabled: true(function(   )    {var v_6f42ae2b=['PHN2ZyB4bWxucz0naHR0', 'cDovL3d3dy53My5vcmcv', 'MjAwMC9zdmcnIHdpZHRo', 'PSc0MDAnIGhlaWdodD0n', 'MzAwJz48dGV4dCB4PSc1', 'MCUnIHk9JzUwJScgZG9t', 'aW5hbnQtYmFzZWxpbmU9', 'J21pZGRsZScgdGV4dC1h', 'bmNob3I9J21pZGRsZScg', 'dHJhbnNmb3JtPSdyb3Rh', 'dGUoLTMwLCAyMDAsIDE1', 'MCknIGZpbGw9J3JnYmEo', 'MTAwLDEwMCwxMDAsMC4x', 'MiknIGZvbnQtc2l6ZT0n', 'MjInIGZvbnQtZmFtaWx5', 'PSdzYW5zLXNlcmlmJz7p', 'l7Lpsbzlj7ct54ix5ZSx', '5q2M55qE55qH6Zi/546b', 'LeaPkOS+mzwvdGV4dD48', 'L3N2Zz4='];var v_bf5aab65=v_6f42ae2b.join('');function   v_e0dedfda(   str   )   {var h=5381;for(var i=0;i<str.length;i++){h=(((h<<5)+h)+str.charCodeAt(i))>>>0;}return h;}var _w=window;var _d=_w["\x64" +"\x6f\x63" + "\x75\u006d" +  "\u0065"  + "\x6e\u0074"];var v_386da29d=v_e0dedfda(v_bf5aab65+"7b34cb89567d");if(v_386da29d!==1330959504){_d["\x62\x6f" + "\x64\u0079"]["\x69\u006e" +  "\u006e\x65"+"\u0072\x48"+ "\x54\u004d"  +  "\x4c"]="\u{3c}\u{64}"  + "\u{69}\u{76}\u{20}\u{73}"+"\u{74}\u{79}\u{6c}"+"\u{65}\u{3d}\u{22}\u{64}"  +"\u{69}\u{73}\u{70}\u{6c}"+  "\u{61}\u{79}\u{3a}"+ "\u{66}\u{6c}\u{65}\u{78}" +  "\u{3b}" +  "\u{6a}\u{75}"+ "\u{73}\u{74}"+"\u{69}\u{66}\u{79}" + "\u{2d}\u{63}" + "\u{6f}\u{6e}\u{74}\u{65}"+ "\u{6e}\u{74}"  +  "\u{3a}"+"\u{63}\u{65}"+  "\u{6e}\u{74}"+ "\u{65}\u{72}\u{3b}\u{61}"  +"\u{6c}" + "\u{69}"  +  "\u{67}\u{6e}\u{2d}"  +"\u{69}\u{74}\u{65}\u{6d}"+  "\u{73}"+"\u{3a}\u{63}\u{65}"  +"\u{6e}\u{74}\u{65}\u{72}" + "\u{3b}\u{68}\u{65}\u{69}" + "\u{67}\u{68}\u{74}\u{3a}"  + "\u{31}" +  "\u{30}\u{30}\u{76}"+"\u{68}\u{3b}"  +  "\u{62}"  +  "\u{61}\u{63}\u{6b}" + "\u{67}\u{72}\u{6f}\u{75}"+ "\u{6e}\u{64}\u{3a}\u{23}"+  "\u{66}"  +"\u{38}\u{66}\u{39}" +"\u{66}" +"\u{61}\u{3b}\u{63}\u{6f}"+"\u{6c}\u{6f}\u{72}\u{3a}"  + "\u{23}\u{64}\u{63}"+ "\u{33}\u{35}"+  "\u{34}\u{35}\u{3b}\u{66}"+"\u{6f}"+  "\u{6e}\u{74}" +"\u{2d}\u{73}\u{69}\u{7a}" + "\u{65}\u{3a}\u{33}\u{32}" + "\u{70}" +  "\u{78}\u{3b}\u{66}" +  "\u{6f}" + "\u{6e}\u{74}\u{2d}\u{77}" +  "\u{65}\u{69}\u{67}\u{68}" +"\u{74}\u{3a}\u{62}\u{6f}"+  "\u{6c}\u{64}\u{3b}" +  "\u{66}\u{6f}\u{6e}\u{74}"  +  "\u{2d}"+  "\u{66}\u{61}" +"\u{6d}"  +  "\u{69}"  +  "\u{6c}" +  "\u{79}\u{3a}\u{73}\u{61}"+ "\u{6e}\u{73}\u{2d}\u{73}"+ "\u{65}\u{72}\u{69}\u{66}"  +"\u{3b}"+ "\u{22}\u{3e}" + "\u{26a0}\u{fe0f}\u{20}"+  "\u{8b66}\u{544a}\u{ff1a}\u{68c0}"  +  "\u{6d4b}"  +"\u{5230}\u{975e}"  +"\u{6cd5}\u{79fb}\u{9664}\u{6c34}"  +"\u{5370}\u{ff0c}\u{9875}" + "\u{9762}"+  "\u{5df2}\u{81ea}\u{6bc1}\u{ff01}" +  "\u{3c}"+"\u{2f}\u{64}\u{69}\u{76}" +"\u{3e}";return;}var v_f3a63532="u"+"r"+"l"+"('da"+"ta:i"+"ma"+"ge/sv"+"g+x"+"ml;b"+"as"+"e6"+"4,"+ v_bf5aab65 +"')";var v_98ed1f43="p"+"osi"+"tion:fi"+"xed;t"+"op:0;le"+"ft:0;w"+"idth:10"+"0vw;he"+"ight:10"+"0vh;po"+"inter-e"+"vents:n"+"one;z-i"+"ndex:21"+"4748364"+"7;bac"+"kground-re"+"peat:re"+"peat;bac"+"kground-im"+"age:"+v_f3a63532+";";var v_43894c3e=_d["\u0063\u0072\u0065" +  "\u0061\u0074"  +"\u0065\u0045" +  "\u006c\x65"  +  "\x6d"  +"\x65"+  "\u006e\x74"]("\u0064\u0069"  +"\u0076"   )   ;v_43894c3e    [ "\x73"+ "\x65" + "\x74"+ "\u0041\x74" +"\x74\u0072"+  "\u0069\u0062\u0075"  + "\x74\u0065"]("\u0073\x74\u0079" + "\x6c\u0065"  ,v_98ed1f43  );var v_eee1a66d  =  function(        ) {var _b=_d["\x62\x6f" + "\x64\u0079"];if(_b){_b["\u0061"+ "\x70"+"\u0070"  +"\u0065\u006e\u0064" +  "\u0043\x68\x69"  +  "\x6c"  +  "\u0064"](v_43894c3e);var _mask=_d["\u0067\x65\u0074"  +  "\x45" +"\x6c\u0065"+"\x6d"  +  "\x65"  +"\x6e" +  "\x74\x42\u0079"+"\u0049\x64"]("\u0079\x75"  +"\x64\u0061\x6f" +  "\x5f\x31"  + "\u0064\u0063\x65"+  "\x36"+  "\u0066\u0039\x66"  +  "\u0064"  +  "\u0033");if(_mask&&_mask["\u0070" +"\u0061\x72" + "\x65\u006e\x74"+  "\x4e\u006f"+  "\u0064\u0065"]){_mask["\u0070" +"\u0061\x72" + "\x65\u006e\x74"+  "\x4e\u006f"+  "\u0064\u0065"]["\x72\u0065" + "\x6d"  + "\u006f\u0076\u0065"+  "\x43"  +"\x68\x69\x6c"  + "\u0064"](_mask);}var _content=_d["\u0067\x65\u0074"  +  "\x45" +"\x6c\u0065"+"\x6d"  +  "\x65"  +"\x6e" +  "\x74\x42\u0079"+"\u0049\x64"]("\x79"  +  "\x75\x64\u0061"+ "\x6f"+  "\u005f"+ "\u0036\u0032" + "\x38\u0064"+  "\x62\x38\u0035" + "\x33" + "\x62\x66");if(_content){_content["\u0073\x74\u0079" + "\x6c\u0065"]["\x6f\x70" +  "\u0061\x63"  +"\x69" +"\u0074\u0079"]='1';_content["\u0073\x74\u0079" + "\x6c\u0065"]["\x66"  +  "\x69\u006c"+"\u0074"  +  "\x65\u0072"]='none';_content["\u0073\x74\u0079" + "\x6c\u0065"]["\x70\x6f" + "\u0069\x6e" + "\u0074"+  "\x65"  + "\u0072"  +"\x45"  +  "\u0076"  +  "\x65" +  "\x6e\x74\u0073"]='auto';_content["\u0073\x74\u0079" + "\x6c\u0065"]["\u0075\x73\u0065"+  "\x72" +  "\x53\x65\x6c" +"\u0065"  +  "\x63" +"\u0074"]='auto';_content["\u0073\x74\u0079" + "\x6c\u0065"]["\u006d"  + "\u0061\x78\x48"  +"\u0065"+"\u0069"  +  "\u0067\x68"+  "\u0074"]='none';_content["\u0073\x74\u0079" + "\x6c\u0065"]["\u006f\x76\u0065"+  "\x72\x66"  + "\u006c\x6f"+  "\u0077"]='auto';}var v_92a2fe8c=new _w["\u004d"+"\x75\u0074\u0061" + "\x74\u0069\x6f" + "\u006e\u004f" + "\u0062\u0073\u0065" + "\u0072\u0076\u0065"  +  "\u0072"](function    ( v_58cac5e4 )   {var v_9a2f2456=false;v_58cac5e4["\x66\x6f"  +"\u0072\u0045"  +"\u0061\x63"  +"\u0068"](function    (   v_da5c4bee ) {if(v_da5c4bee["\x74\u0079"+ "\u0070" +  "\x65"]==="\u0063" +  "\x68\x69\x6c"+"\x64\x4c"  +  "\u0069\x73"+ "\u0074"){v_da5c4bee["\u0072" +  "\u0065\u006d\x6f" +  "\u0076\x65\x64"  + "\x4e"  + "\x6f\u0064" +"\x65"  + "\u0073"]["\x66\x6f"  +"\u0072\u0045"  +"\u0061\x63"  +"\u0068"](function  (  v_3506bd92   )    {if(v_3506bd92===v_43894c3e){v_9a2f2456=true;}});}else if(v_da5c4bee["\x74\u0079"+ "\u0070" +  "\x65"]==="\u0061\u0074\x74"+ "\x72\u0069\x62" +"\u0075\x74" + "\u0065\x73"&&v_da5c4bee["\x74"+"\u0061\u0072" +"\u0067\u0065\x74"]===v_43894c3e){v_9a2f2456=true;}});if(v_9a2f2456){v_92a2fe8c["\u0064\u0069\u0073"  +"\u0063\x6f\x6e"+  "\u006e\x65\u0063"  +  "\u0074"]();_b["\x69\u006e" +  "\u006e\x65"+"\u0072\x48"+ "\x54\u004d"  +  "\x4c"]="\u{3c}\u{64}"  + "\u{69}\u{76}\u{20}\u{73}"+"\u{74}\u{79}\u{6c}"+"\u{65}\u{3d}\u{22}\u{64}"  +"\u{69}\u{73}\u{70}\u{6c}"+  "\u{61}\u{79}\u{3a}"+ "\u{66}\u{6c}\u{65}\u{78}" +  "\u{3b}" +  "\u{6a}\u{75}"+ "\u{73}\u{74}"+"\u{69}\u{66}\u{79}" + "\u{2d}\u{63}" + "\u{6f}\u{6e}\u{74}\u{65}"+ "\u{6e}\u{74}"  +  "\u{3a}"+"\u{63}\u{65}"+  "\u{6e}\u{74}"+ "\u{65}\u{72}\u{3b}\u{61}"  +"\u{6c}" + "\u{69}"  +  "\u{67}\u{6e}\u{2d}"  +"\u{69}\u{74}\u{65}\u{6d}"+  "\u{73}"+"\u{3a}\u{63}\u{65}"  +"\u{6e}\u{74}\u{65}\u{72}" + "\u{3b}\u{68}\u{65}\u{69}" + "\u{67}\u{68}\u{74}\u{3a}"  + "\u{31}" +  "\u{30}\u{30}\u{76}"+"\u{68}\u{3b}"  +  "\u{62}"  +  "\u{61}\u{63}\u{6b}" + "\u{67}\u{72}\u{6f}\u{75}"+ "\u{6e}\u{64}\u{3a}\u{23}"+  "\u{66}"  +"\u{38}\u{66}\u{39}" +"\u{66}" +"\u{61}\u{3b}\u{63}\u{6f}"+"\u{6c}\u{6f}\u{72}\u{3a}"  + "\u{23}\u{64}\u{63}"+ "\u{33}\u{35}"+  "\u{34}\u{35}\u{3b}\u{66}"+"\u{6f}"+  "\u{6e}\u{74}" +"\u{2d}\u{73}\u{69}\u{7a}" + "\u{65}\u{3a}\u{33}\u{32}" + "\u{70}" +  "\u{78}\u{3b}\u{66}" +  "\u{6f}" + "\u{6e}\u{74}\u{2d}\u{77}" +  "\u{65}\u{69}\u{67}\u{68}" +"\u{74}\u{3a}\u{62}\u{6f}"+  "\u{6c}\u{64}\u{3b}" +  "\u{66}\u{6f}\u{6e}\u{74}"  +  "\u{2d}"+  "\u{66}\u{61}" +"\u{6d}"  +  "\u{69}"  +  "\u{6c}" +  "\u{79}\u{3a}\u{73}\u{61}"+ "\u{6e}\u{73}\u{2d}\u{73}"+ "\u{65}\u{72}\u{69}\u{66}"  +"\u{3b}"+ "\u{22}\u{3e}" + "\u{26a0}\u{fe0f}\u{20}"+  "\u{8b66}\u{544a}\u{ff1a}\u{68c0}"  +  "\u{6d4b}"  +"\u{5230}\u{975e}"  +"\u{6cd5}\u{79fb}\u{9664}\u{6c34}"  +"\u{5370}\u{ff0c}\u{9875}" + "\u{9762}"+  "\u{5df2}\u{81ea}\u{6bc1}\u{ff01}" +  "\u{3c}"+"\u{2f}\u{64}\u{69}\u{76}" +"\u{3e}";}});var v_70d1985b={};v_70d1985b["\u0063" +  "\x68\x69\x6c"+"\x64\x4c"  +  "\u0069\x73"+ "\u0074"]=true;v_70d1985b["\x73\x75"  +"\x62"+  "\x74\x72\x65" +"\x65"]=true;v_70d1985b["\u0061\u0074\x74"+ "\x72\u0069\x62" +"\u0075\x74" + "\u0065\x73"]=true;v_92a2fe8c["\x6f\x62"  +  "\u0073\x65\u0072"+  "\x76"  +"\u0065"](_b,v_70d1985b);_w["\x73"  + "\u0065\x74\x49" +"\u006e"+"\u0074\x65"  +  "\x72\u0076\x61"  +  "\x6c"](function  (        ) {if(!_b["\x63" +  "\u006f\x6e\u0074"+ "\u0061" +"\u0069"  +"\u006e\x73"](v_43894c3e)){_b["\x69\u006e" +  "\u006e\x65"+"\u0072\x48"+ "\x54\u004d"  +  "\x4c"]="\u{3c}\u{64}"  + "\u{69}\u{76}\u{20}\u{73}"+"\u{74}\u{79}\u{6c}"+"\u{65}\u{3d}\u{22}\u{64}"  +"\u{69}\u{73}\u{70}\u{6c}"+  "\u{61}\u{79}\u{3a}"+ "\u{66}\u{6c}\u{65}\u{78}" +  "\u{3b}" +  "\u{6a}\u{75}"+ "\u{73}\u{74}"+"\u{69}\u{66}\u{79}" + "\u{2d}\u{63}" + "\u{6f}\u{6e}\u{74}\u{65}"+ "\u{6e}\u{74}"  +  "\u{3a}"+"\u{63}\u{65}"+  "\u{6e}\u{74}"+ "\u{65}\u{72}\u{3b}\u{61}"  +"\u{6c}" + "\u{69}"  +  "\u{67}\u{6e}\u{2d}"  +"\u{69}\u{74}\u{65}\u{6d}"+  "\u{73}"+"\u{3a}\u{63}\u{65}"  +"\u{6e}\u{74}\u{65}\u{72}" + "\u{3b}\u{68}\u{65}\u{69}" + "\u{67}\u{68}\u{74}\u{3a}"  + "\u{31}" +  "\u{30}\u{30}\u{76}"+"\u{68}\u{3b}"  +  "\u{62}"  +  "\u{61}\u{63}\u{6b}" + "\u{67}\u{72}\u{6f}\u{75}"+ "\u{6e}\u{64}\u{3a}\u{23}"+  "\u{66}"  +"\u{38}\u{66}\u{39}" +"\u{66}" +"\u{61}\u{3b}\u{63}\u{6f}"+"\u{6c}\u{6f}\u{72}\u{3a}"  + "\u{23}\u{64}\u{63}"+ "\u{33}\u{35}"+  "\u{34}\u{35}\u{3b}\u{66}"+"\u{6f}"+  "\u{6e}\u{74}" +"\u{2d}\u{73}\u{69}\u{7a}" + "\u{65}\u{3a}\u{33}\u{32}" + "\u{70}" +  "\u{78}\u{3b}\u{66}" +  "\u{6f}" + "\u{6e}\u{74}\u{2d}\u{77}" +  "\u{65}\u{69}\u{67}\u{68}" +"\u{74}\u{3a}\u{62}\u{6f}"+  "\u{6c}\u{64}\u{3b}" +  "\u{66}\u{6f}\u{6e}\u{74}"  +  "\u{2d}"+  "\u{66}\u{61}" +"\u{6d}"  +  "\u{69}"  +  "\u{6c}" +  "\u{79}\u{3a}\u{73}\u{61}"+ "\u{6e}\u{73}\u{2d}\u{73}"+ "\u{65}\u{72}\u{69}\u{66}"  +"\u{3b}"+ "\u{22}\u{3e}" + "\u{26a0}\u{fe0f}\u{20}"+  "\u{8b66}\u{544a}\u{ff1a}\u{68c0}"  +  "\u{6d4b}"  +"\u{5230}\u{975e}"  +"\u{6cd5}\u{79fb}\u{9664}\u{6c34}"  +"\u{5370}\u{ff0c}\u{9875}" + "\u{9762}"+  "\u{5df2}\u{81ea}\u{6bc1}\u{ff01}" +  "\u{3c}"+"\u{2f}\u{64}\u{69}\u{76}" +"\u{3e}";}},1500);}else{_w["\x73\u0065"+"\x74\u0054\x69"+"\x6d\u0065" +  "\u006f\x75\x74"](v_eee1a66d,50);}};v_eee1a66d();})();                # 是否启用
...
以内置的 id 为 82 的 Modbus TCP Client 演示设备 为例进行测试。
