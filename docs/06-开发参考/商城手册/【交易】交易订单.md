...
这块已经在 [《微信公众号支付接入》](/开发参考/支付手册/微信公众号支付接入.md)、[《微信小程序支付接入》](/开发参考/支付手册/微信小程序支付接入.md) 文档中介绍过了，这里就不再赘述。
...
ps：微信小程序的发货，可以使用订阅消息功能，具体可以后面看看 [《微信小程序订阅消息》](/开发参考/会员手册/微信小程序订阅消息.md) 文档。
...
① 买家点击「评价」按钮，进入评价页，这块已经在 [《【商品】商品评价》](/开发参考/商城手册/【商品】商品评价.md) 文档中介绍过了，这里就不再赘述。
