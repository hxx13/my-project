...
实际上，`ruoyi-vue-pro` 本质上还是个**单体**项目，直接在根目录 `pom.xml` 管理依赖版本会更加方便，也符合绝大多数程序员的认知。但是要额外考虑一个场景，如果每个 `yudao-module-xxx` 模块都维护在一个独立的 Git 仓库，那么 `yudao-dependencies` 就可以在多个 `yudao-module-xxx` 模块下复用。
...
-   [《接口文档》](/开发参考/萌新必读/接口文档.md)
-   [《VO 对象转换、数据翻译》](/开发参考/后端手册/VO 对象转换、数据翻译.md)
...
-   [《MyBatis 数据库》](/开发参考/后端手册/MyBatis 数据库.md)
-   [《MyBatis 联表x分页》](/开发参考/后端手册/MyBatis 联表&分页查询.md)
-   [《Redis 缓存》](/开发参考/后端手册/Redis 缓存.md)
...
-   [《消息队列（内存）》](/开发参考/中间件手册/消息队列（内存）.md)
-   [《消息队列（Redis）》](/开发参考/中间件手册/消息队列（Redis）.md)
-   [《消息队列（Kafka）》](/开发参考/中间件手册/消息队列（Kafka）.md)
-   [《消息队列（RocketMQ）》](/开发参考/中间件手册/消息队列（RocketMQ）.md)
-   [《消息队列（RabbitMQ）》](/开发参考/中间件手册/消息队列（RabbitMQ）.md)
...
-   [《工具类 Util》](/开发参考/后端手册/工具类 Util.md)
