...
![AI 知识库的案例](/knowledge-images/544d720b271a.png)

整个功能，涉及到 3 个表：

![表关系图](/knowledge-images/b3a0951d5ea7.png)
...
![AI 知识库新建](/knowledge-images/98f10db65537.png)
...
![AI 知识库文档](/knowledge-images/e81adb1ac6bb.png)

它的后端 HTTP 接口，由 `yudao-module-ai` 模块的 `model` 包的 AiKnowledgeDocumentController 实现。

② 点击「新建」按钮，上传文件（支持多个），不断点击「下一步」按钮，即可创建文档。如下图所示：

![AI 知识库文档新建](/knowledge-images/aef248ee7a59.png)

![AI 知识库文档新建2](/knowledge-images/278bc96aae3c.png)

![AI 知识库文档新建3](/knowledge-images/f4aacc24d57e.png)
...
![AI 知识库段落](/knowledge-images/3f8013f67d75.png)

② 除了上述文档的方式，我们也可以点击「新建」或者「编辑」按钮，手动创建或编辑段落。如下图所示：

![AI 知识库段落新建](/knowledge-images/20183700a552.png)
...
![AI 知识库召回测试](/knowledge-images/9d124c0926e0.png)

###  4.2 接入 AI 聊天

① 第一步，在角色配置时，关联对应的 AI 知识库，可多选。如下图所示：

![AI 知识库角色配置](/knowledge-images/89f6489fdcb9.png)
...
![EmbeddingModel 实现](/knowledge-images/8600be08279d.png)
...
![VectorStore 实现](/knowledge-images/280b237fe089.png)
...
![VectorStore 切换](/knowledge-images/5221c9984c03.png)
