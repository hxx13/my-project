...
由于 Coze 的 [对话接口](https://www.coze.cn/open/playground/chat_v3) 不兼容 GPT 的接口，所以无法使用 《【模型接入】OpenAI》 的方式，无法通过 OpenAIChatModel 进行接入。
...
下面，我们讲解下，如何把我们系统中的 《AI 对话聊天》 ，接入到 Coze 智能体（Agent）。
...
![API 密钥](/knowledge-images/70e4d7498b49.png)

② 在我们系统的 [AI 大模型 -> 控制台 -> 模型配置] 菜单，新建一个 Coze 的聊天模型，填写上面的“模型名称” + “API 密钥” + “API URL”。如下图所示：

![模型配置](/knowledge-images/ef819c254403.png)

###  2.3 第三步：AI 对话聊天

在 [AI 大模型 -> AI 对话] 菜单，选择 Coze 的聊天模型，即可开始对话。如下图所示：

![AI 对话](/knowledge-images/2ef69902b254.png)

##  3. 常见问题？

① 如果你想使用 Coze 知识库接口，可参考 [https://www.coze.cn/open/playground/create\_dataset](https://www.coze.cn/open/playground/create_dataset) 进行对接。

当然，我们系统已经提供了 《AI 知识库》 功能。

FastGPT 工作流 推理模式（thinking）
