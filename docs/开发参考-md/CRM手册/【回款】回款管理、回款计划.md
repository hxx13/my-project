...
回款模块，由 `yudao-module-crm` 后端模块的 `receivable` 包实现，已经和 BPM 工作流 打通审批。
...
![表关系](/knowledge-images/323b2abdb317.png)
...
![待回款提醒](/knowledge-images/a6c0da4a8925.png)

###  2.2 管理后台

对应 [CRM 系统 -> 回款计划] 菜单，对应 `yudao-ui-admin-vue3` 项目的 `@/views/crm/receivable/plan` 目录。

![回款计划](/knowledge-images/ed5fff8301da.png)

① 点击【新增】按钮，随便填写一些信息，点击「确认」按钮，即可新增一条回款计划。如下图所示：

![新增回款计划](/knowledge-images/29478bc95281.png)

② 点击【创建回款】按钮，可以创建回款。如下图所示：

![创建回款（回款计划）](/knowledge-images/2685864e933e.png)

这样，我们就完成了【合同】=>【回款计划】=>【回款】的整个回款链路。

③ 点击“期数”，进入回款计划详情页，可以查看回款计划的详细信息，如下图所示：

![回款计划详情](/knowledge-images/6ac227aba1b1.png)

---

另外，也可以在【合同】的详情页，进行【回款计划】的创建。如下图所示：

![新增回款计划（合同）](/knowledge-images/b558d7f2f16c.png)

【合同】合同管理、合同提醒 【产品】产品管理、产品分类
