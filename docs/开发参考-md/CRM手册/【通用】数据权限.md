...
![CrmPermission 注解](/knowledge-images/a9adcf6597bf.png)

① 使用示例，如下图所示：

![CrmPermission 注解使用示例](/knowledge-images/8a008996f5d2.png)

② 通过 Spring AOP 实现，可见 CrmPermissionAspect 类，如下图所示：

![CrmPermissionAspect 类](/knowledge-images/b27a6fc09cc8.png)
...
![CRM 管理员](/knowledge-images/78c3f1df195b.png)
