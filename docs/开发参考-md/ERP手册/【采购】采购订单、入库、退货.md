...
![表关系](/knowledge-images/13ff7d3da4a3.png)

它的整体流程，如下图所示：

![整体流程](/knowledge-images/1f32cd18658d.png)
...
![供应商信息](/knowledge-images/d1a434db2fe6.png)
...
![采购订单](/knowledge-images/5049b4243fc7.png)

① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条采购订单。

![新增采购订单](/knowledge-images/a666523143db.png)
...
![采购入库](/knowledge-images/f72abd708696.png)

① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条采购入库。

![新增采购入库](/knowledge-images/a0ddc9aac1ab.png)

② 点击该采购入库的「审批」按钮，审批通过该采购入库，此时状态会变成“已审批”，同时会增加对应的库存、新增库存明细。如下图所示：

![审批采购入库](/knowledge-images/e728c8ca9155.png)

③ 点击该采购入库的「反审批」按钮，反审批该采购入库，此时状态会变成“未审批”，同时会减少对应的库存、新增库存明细。如下图所示：

![反审批采购入库](/knowledge-images/28c43a9c7ac8.png)
...
![采购退货](/knowledge-images/c8f21432404c.png)

① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条采购退货。

![新增采购退货](/knowledge-images/de2ea9434edc.png)

② 点击该采购退货的「审批」按钮，审批通过该采购退货，此时状态会变成“已审批”，同时会减少对应的库存、新增库存明细。如下图所示：

![审批采购退货](/knowledge-images/331303e81a26.png)

③ 点击该采购退货的「反审批」按钮，反审批该采购退货，此时状态会变成“未审批”，同时会增加对应的库存、新增库存明细。如下图所示：

![反审批采购退货](/knowledge-images/123d7747bafe.png)

##  5. 采购付款

参见 《【财务】采购付款、销售收款》 文档。

【库存】库存调拨、库存盘点 【销售】销售订单、出库、退货
