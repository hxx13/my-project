...
![表关系](/knowledge-images/6605567ed561.png)

它的整体流程，如下图所示：

![整体流程](/knowledge-images/9f4a29315779.png)
...
![客户信息](/knowledge-images/21ea1580f43d.png)
...
![销售订单](/knowledge-images/e721cb7a33ce.png)

① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条销售订单。

![新增销售订单](/knowledge-images/dd3f7acdb226.png)
...
![销售出库](/knowledge-images/b7631312a0a6.png)

① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条销售出库。

![新增销售出库](/knowledge-images/e02ee1078587.png)

② 点击该销售出库的「审批」按钮，审批通过该销售出库，此时状态会变成“已审批”，同时会减少对应的库存、新增库存明细。如下图所示：

![审批销售出库](/knowledge-images/73d282fd8993.png)

③ 点击该销售出库的「反审批」按钮，反审批该销售出库，此时状态会变成“未审批”，同时会增加对应的库存、新增库存明细。如下图所示：

![反审批销售出库](/knowledge-images/0177b6e11599.png)
...
![销售退货](/knowledge-images/4b6ff222a90b.png)

① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条销售退货。

![新增销售退货](/knowledge-images/98ca4e3a77d9.png)

② 点击该销售退货的「审批」按钮，审批通过该销售退货，此时状态会变成“已审批”，同时会增加对应的库存、新增库存明细。如下图所示：

![审批销售退货](/knowledge-images/d290b191951f.png)

③ 点击该销售退货的「反审批」按钮，反审批该销售退货，此时状态会变成“未审批”，同时会减少对应的库存、新增库存明细。如下图所示：

![反审批销售退货](/knowledge-images/101a2542b433.png)

##  5. 销售收款

参见 《【财务】采购付款、销售收款》 文档。

【采购】采购订单、入库、退货 【财务】采购付款、销售收款
