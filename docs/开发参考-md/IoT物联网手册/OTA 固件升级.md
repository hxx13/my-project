...
![OTA 固件升级](/knowledge-images/fcf3d3b2b845.png)
...
![固件管理 - 固件列表](/knowledge-images/06ef5508e015.png)

###  1.3 管理后台（创建/编辑）

① 点击【新增】按钮，弹出表单对话框。

![固件管理 - 创建固件](/knowledge-images/1ce1a72e1005.png)
...
![固件管理 - 固件详情](/knowledge-images/866432174819.png)
...
![升级任务 - 任务列表](/knowledge-images/61169ecef0e4.png)

② 点击【新增任务】按钮，弹出创建表单：

![升级任务 - 创建任务](/knowledge-images/55c782d9e315.png)
...
![升级任务 - 任务详情](/knowledge-images/c3133b7d11cd.png)
