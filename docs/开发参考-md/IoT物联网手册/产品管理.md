...
![产品模块](/knowledge-images/a55f36232012.png)
...
![管理后台 - 产品分类](/knowledge-images/6c2a042f73c5.png)
...
![管理后台 - 产品列表](/knowledge-images/51d376907f89.png)
...
![管理后台 - 产品新增](/knowledge-images/61c4baa306a1.png)

###  2.4 管理后台（详情）

点击产品名称，进入产品详情页。详情页采用 Tab 页签设计，对应前端项目的 `@/views/iot/product/product/detail` 目录。

![管理后台 - 产品详情](/knowledge-images/e413481f98ad.png)
