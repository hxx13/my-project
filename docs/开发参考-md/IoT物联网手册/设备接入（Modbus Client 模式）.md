...
![点位配置](/knowledge-images/f28780e9544a.png)
...
![属性数据](/knowledge-images/56fed6f667bd.png)

![属性消息日志](/knowledge-images/e3776f3637e1.png)
...
设备接入（CoAP 协议） 设备接入（Modbus Server 模式）
