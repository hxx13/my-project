...
![整体架构](/knowledge-images/390655de753a.png)
...
![模块结构](/knowledge-images/0539140b8f27.png)
...
- **网关设备**：指物联网中的一类**硬件设备**，能够代理多个子设备接入平台。详见 《设备网关与子设备》。
...
![设备认证信息](/knowledge-images/ef888767c4cc.png)
...
- 【自定义】如需扩展新的序列化格式，可参考 《设备接入（自定义协议）》的「C. 自定义序列化」
