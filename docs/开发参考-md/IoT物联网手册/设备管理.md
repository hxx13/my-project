...
![设备模块](/knowledge-images/a238f1622dbb.png)
...
![管理后台 - 设备分组](/knowledge-images/a6f80aa61b81.png)
...
![管理后台 - 设备列表](/knowledge-images/8fdb4424ed36.png)
...
![管理后台 - 设备新增](/knowledge-images/d467afad9459.png)

###  2.4 管理后台（详情）

点击设备名称，进入设备详情页。详情页采用多 Tab 页签设计，对应前端项目的 `@/views/iot/device/device/detail` 目录。

![管理后台 - 设备详情](/knowledge-images/24a4370845ee.png)
...
![管理后台 - 设备详情 - 物模型数据](/knowledge-images/56f4702245e8.png)
...
![管理后台 - 设备详情 - 设备消息](/knowledge-images/6f854c5c9bb6.png)
...
![管理后台 - 设备详情 - 模拟设备](/knowledge-images/686b24622c00.png)
...
![管理后台 - 设备详情 - 设备配置](/knowledge-images/230630f186f1.png)

####  2.4.7 Modbus 配置 Tab

仅 Modbus 协议的设备显示此 Tab，用于配置 Modbus 连接参数和点位映射，包括寄存器地址、数据类型、读写操作等。

详细可见 《设备接入（Modbus Client 模式）》 和 《设备接入（Modbus Server 模式）》。
