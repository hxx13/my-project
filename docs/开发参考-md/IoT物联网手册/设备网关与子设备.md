...
> （图片来自阿里云）
>
> ![网关与子设备架构图](/knowledge-images/507b898850af.png)
...
![产品设备类型](/knowledge-images/6eaeef368e4b.png)
...
- 子设备动态注册：`thing.auth.register.sub`（详见 《设备动态注册》）
