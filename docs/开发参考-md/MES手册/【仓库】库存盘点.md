...
![库存盘点模块](/knowledge-images/d451ecea7199.svg)
...
![管理后台 - 盘点方案列表](/knowledge-images/62fddfbbff1c.png)
...
② `type` 为参数类型，枚举 MesWmStockTakingPlanParamTypeEnum（WAREHOUSE=仓库，LOCATION=库区，AREA=库位，ITEM=物料，BATCH=批次，QUALITY\_STATUS=质量状态），决定盘点范围按哪个维度筛选。
...
![管理后台 - 盘点任务列表](/knowledge-images/6105d07ff779.png)
...
![管理后台 - 盘点任务新增](/knowledge-images/97fce2c01f1e.png)
