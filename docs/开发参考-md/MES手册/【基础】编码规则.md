...
![编码规则模块](/knowledge-images/10ac47e2ca30.svg)
...
![编码规则策略类关系](/knowledge-images/ebde4f9fbace.png)
...
![管理后台 - 编码规则列表](/knowledge-images/5dc57ef14ed2.png)
...
![管理后台 - 编码规则新增](/knowledge-images/c032de564b61.png)

####  修改

点击【编辑】按钮，弹出编码规则修改表单（宽 1000px 弹窗），底部包含该规则的**规则组成分段列表**。用户可在修改弹窗中同时维护规则的基本信息和分段配置。

![管理后台 - 编码规则修改](/knowledge-images/41a8aed200f9.png)
...
![管理后台 - 规则组成列表](/knowledge-images/70e123e1723e.png)
