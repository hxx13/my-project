...
![排班执行模块](/knowledge-images/4c8a0506a85b.svg)
...
② `team_id` 关联 `mes_cal_team` 表的 `id` 字段（详见 《【排班】班组设置、节假日设置》）。
...
![管理后台 - 排班日历](/knowledge-images/ca9bf5b8ecc6.png)

【排班】班组设置、节假日设置 WMS 演示
