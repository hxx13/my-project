...
![工序与工艺流程模块](/knowledge-images/0abaef1bc119.svg)
...
![管理后台 - 工序列表](/knowledge-images/9b3c82f197dc.png)

####  新增

点击【新增】按钮，弹出工序新增表单。主要填写工序编码（可点击「生成」按钮自动生成）、工序名称、状态（开启/关闭）、工序说明和备注。

![管理后台 - 工序新增](/knowledge-images/9ea8e4fa3870.png)

####  修改

点击编码链接或【编辑】按钮，弹出工序修改表单。在表单下方自动展示该工序的**操作步骤列表**。

![管理后台 - 工序修改+操作步骤](/knowledge-images/6dc50eae5738.png)
...
![管理后台 - 关联产品](/knowledge-images/db3b85b0957b.png)
...
![管理后台 - 工序级 BOM](/knowledge-images/d92b8a94f78c.png)
