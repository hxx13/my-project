...
![设备基础数据模块](/knowledge-images/7d2041a25924.svg)
...
![管理后台 - 设备类型](/knowledge-images/cb8150d8fde0.png)
...
![管理后台 - 设备台账列表](/knowledge-images/b345c13beb9c.png)
...
![管理后台 - 设备台账修改](/knowledge-images/f07b65ede0c1.png)

> **删除限制**：删除设备前，系统会校验该设备无关联的点检方案、点检记录、保养记录、维修记录，否则禁止删除。

【质量】待检任务、检验结果、缺陷记录 【设备】点检保养项目、点检保养方案
