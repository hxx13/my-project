...
![质量基础数据模块](/knowledge-images/bdc5086a350a.svg)
...
![管理后台 - 检测项列表](/knowledge-images/c9536a2af1da.png)

####  新增/修改

点击【新增】或【编辑】按钮，弹出检测项表单。主要填写检测项编码（可自动生成）、名称、类型、检测工具、结果类型。

![管理后台 - 检测项编辑](/knowledge-images/de6dd296a5ed.png)
...
![管理后台 - 常见缺陷列表](/knowledge-images/6f536bb121ef.png)

####  新增/修改

点击【新增】或【编辑】按钮，弹出缺陷表单。主要填写缺陷编码（可自动生成）、缺陷描述、检测项类型、缺陷等级。

![管理后台 - 常见缺陷编辑](/knowledge-images/eca7df870869.png)
...
- **检测项**是质检方案的组成单元。一个质检方案包含多个检测项（通过 `mes_qc_template_indicator` 关联），每个检测项定义检测内容和结果类型。详见 《【质量】质检方案》。
