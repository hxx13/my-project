...
![质检方案模块](/knowledge-images/f2af1a8e2301.svg)
...
![管理后台 - 质检方案列表](/knowledge-images/d0f7a77dfbbb.png)

####  新增

点击【新增】按钮，弹出质检方案表单。主要填写方案编码（可自动生成）、方案名称、检验类型（多选）、状态。保存成功后弹窗自动关闭，刷新列表。

![管理后台 - 质检方案新增](/knowledge-images/2a6b736b50d8.png)

####  修改

点击操作列的【编辑】按钮，弹出修改表单。点击编码链接打开的是**详情**（只读模式）。编辑弹窗下方展示子表数据（需先保存主表后才会显示子表 Tab）：

![管理后台 - 质检方案修改](/knowledge-images/910e49f5103b.png)
...
![管理后台 - 产品关联](/knowledge-images/48e9744cdc39.png)
