...
![管理后台](/knowledge-images/d29609be5367.png)
...
![交流群](/knowledge-images/92837ba427ce.png)

##  4. 功能描述

主要包含：基础数据、库存管理，以及入库 / 出库 / 移库 / 盘库四类业务单据。

![WMS 功能列表](/knowledge-images/acd6a46fd357.png)

##  5. 表结构

WMS 共 **16** 张表，覆盖物料主数据、库存台账与流水、出入库 / 移库 / 盘库四类业务单据，表名统一以 `wms_` 为前缀：

![WMS 全表关系](/knowledge-images/c7629d4f4374.png)
