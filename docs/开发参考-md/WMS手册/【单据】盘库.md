...
![盘库单列表](/knowledge-images/2d8439de287e.png)

####  新增

① 点击列表「新增」按钮，先弹出「选择盘库仓库」前置框，选定仓库后才会进入新增弹窗 —— 因为盘库要按仓库拉取库存当账面快照，仓库不确定就无法初始化明细。

![盘库单新增 - 选仓库](/knowledge-images/4b7f747ae37a.png)
...
![盘库单新增](/knowledge-images/d9d0d280daf8.png)
...
![盘库单网页打印](/knowledge-images/0860458232a6.png)

【单据】移库 【其它】WMS、MES、ERP 对比
