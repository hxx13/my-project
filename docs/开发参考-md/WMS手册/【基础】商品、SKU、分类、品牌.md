...
![商品列表](/knowledge-images/f47579ecec06.png)
...
![商品表单](/knowledge-images/b93e1583f02e.png)
...
![商品分类列表](/knowledge-images/6898d4292a49.png)

新增 / 修改通过弹窗 `ItemCategoryForm.vue` 完成，表单字段：上级分类、分类编号、分类名称、显示排序、状态。

![商品分类表单](/knowledge-images/b246cdfbe4ed.png)
...
![商品品牌列表](/knowledge-images/725958fce2f1.png)

新增 / 修改通过弹窗 `ItemBrandForm.vue` 完成，表单仅品牌编号（带【生成】按钮）、品牌名称 2 个字段。

![商品品牌表单](/knowledge-images/c11ae90b2df8.png)
