...
![集群消费](/knowledge-images/5ff20ca0ca22.png)
...
![YudaoRedisMQAutoConfiguration](/knowledge-images/e8e5dacd3566.png)

###  1.3 实战案例

以【短信发送】举例子，改造使用 Redis 作为消息队列，同时也是讲解集群消费的使用。如下图所示：

![实战案例](/knowledge-images/951f0db1945a.png)
...
![简单测试](/knowledge-images/7d81d49e6018.png)
...
![集群消费](/knowledge-images/728ef57855c8.png)
...
![YudaoRedisMQAutoConfiguration](/knowledge-images/8fc488356aad.png)
