...
本文是 《三方登录》 的延伸，讲解 [`yudao-mall-uniapp`](https://github.com/yudaocode/yudao-mall-uniapp) 商城小程序如何实现微信 **公众号** 登录的功能。
...
![测试公众号 - 密钥](/knowledge-images/53faea5891fc.png)

![ 配置项](/knowledge-images/c0ba73010d95.png)

③ 修改“JS接口安全域名”，设置为前端的访问地址。例如说，现在本地是 `http://127.0.0.1:3000`。如下图所示：

![JS 接口安全域名.png](/knowledge-images/58367dc70284.png)

注意：自己需要关注下自己的测试公众号！！！

④ 修改“网页授权获取用户基本信息”，设置为前端的访问地址。例如说，现在本地是 `http://127.0.0.1:3000`。如下图所示：

![网页授权获取用户基本信息](/knowledge-images/e559a07852de.png)

补充说明：如果你是正式的公众号，需要额外看下这部分的内容：

① 设置“IP白名单”，在公众号的 [设置与开发 - 安全中心] 菜单，如下图所示：

![IP 白名单](/knowledge-images/5acdde61757d.png)

② 在公众号的 [设置与开发 - 公众号设置] 菜单，设置“业务域名”、“JS接口安全域名”、“网页授权域名”，如下图所示：

![公众号设置](/knowledge-images/50434c99f2e0.png)
...
![公众号网页项目](/knowledge-images/884005a1d212.png)
...
![登录弹窗](/knowledge-images/989607d0323a.png)
...
![微信公众号的登录地址](/knowledge-images/8f858782d481.png)
