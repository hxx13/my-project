...
本文是 《三方登录》 的延伸，讲解 [`yudao-mall-uniapp`](https://github.com/yudaocode/yudao-mall-uniapp) 商城小程序如何实现微信 **小程序** 订阅消息的功能。对应的官方文档如下：
...
![订阅消息](/knowledge-images/f133cc9173f4.png)

上图可以看到三个模版，是目前项目已经接入的订阅消息：

- 【商城】订单发货通知：管理员在后台发货后，通知用户
  ![订单发货通知](/knowledge-images/5e5e338309bb.png)
- 【商城】拼团结果通知：用户拼团成功后，通知用户
  ![拼团结果通知](/knowledge-images/b225242c84e8.png)
- 【支付】充值成功通知：用户充值成功后，通知用户
  ![充值成功通知](/knowledge-images/a8a2f3f0a456.png)
...
![后端配置](/knowledge-images/5aeece0e7ac8.png)
...
![支付成功页](/knowledge-images/5aac59c2275d.png)

第二步，点击【立即订阅】按钮，发起对“订单发货通知”的订阅消息。如下图所示：

![发起订阅消息](/knowledge-images/cf94acece938.png)
...
![订单发货](/knowledge-images/124dc01ea34b.png)
...
![服务通知](/knowledge-images/a6422bd5067e.png)
