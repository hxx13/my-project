...
![界面](/knowledge-images/9c091632d7fb.png)
...
![表结构](/knowledge-images/d8e17ed15953.png)
...
![上传永久素材](/knowledge-images/9c8143197646.png)
...
![上传临时素材](/knowledge-images/9bdfbff679e8.png)

② 来源二：在接收到用户消息时，如果是图片、语音、视频素材，需要先下载到自己的文件服务器上，避免超过 3 天后无法访问的问题。如下图所示：

图片纠错：最新版本不区分 yudao-module-mp-api 和 yudao-module-mp-biz 子模块，代码直接合并到 yudao-module-mp 模块的 src 目录下，更适合单体项目

![下载临时素材](/knowledge-images/6863f70a3ecf.png)
