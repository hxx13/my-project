...
![字典管理](/knowledge-images/b7a79ad1ba56.png)

##  1. 全局缓存

用户登录成功后，前端会从后端获取到全量的字典数据，缓存在 store 中。如下图所示：

![字典 store](/knowledge-images/1701e9fcc13b.png)
...
![ 枚举](/knowledge-images/5016e8b39832.png)
...
![DictTag](/knowledge-images/f04192069830.png)
