...
![静态路由](/knowledge-images/e8e7b2c85ea1.png)
...
![动态路由](/knowledge-images/cc5930c6f7b9.png)
...
![系统管理 -> 菜单管理](/knowledge-images/59d1b8a11663.png)

菜单可在 [系统管理 -> 角色管理] 被分配给角色。如下图所示：

![系统管理 -> 角色管理](/knowledge-images/695558b8fa73.png)

###  3.1 新增目录

① 大多数情况下，目录是作为菜单的【分类】：

![新增目录 —— 菜单的分类](/knowledge-images/88b1dc3b0607.png)

② 目录也提供实现【外链】的能力：

![新增目录 —— 外链](/knowledge-images/35ace7dc25c6.png)

###  3.2 新增菜单

![新增菜单](/knowledge-images/994f42a2d07e.png)

###  3.3 新增按钮

![新增按钮](/knowledge-images/85bc168a30b8.png)
...
![示例](/knowledge-images/a90fb2b06a0f.png)
