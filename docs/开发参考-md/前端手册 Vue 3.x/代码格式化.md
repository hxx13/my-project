...
![JetBrains 端自动格式化](/knowledge-images/e916214a3722.png)
...
![VS Code 端自动格式化 - 设置](/knowledge-images/c78655dfda4e.png)

③ 随便打开一个 Vue 文件，右键选择 `Format Document` 或者 `格式化文档`，然后选择 Prettier 即可。如下图所示：

![VS Code 端自动格式化 - 开启](/knowledge-images/0fb6e09cd78b.png)
