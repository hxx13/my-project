...
![字典管理](/knowledge-images/84c9725bebd8.png)

##  1. 全局缓存

用户登录成功后，前端会从后端获取到全量的字典数据，缓存在 store 中。如下图所示：

![字典 store](/knowledge-images/4ef98bcab894.png)
...
![ 枚举](/knowledge-images/e47e9bfb84c8.png)
