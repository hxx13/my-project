...
![静态路由](/knowledge-images/ea71b35f316e.png)
...
![动态路由](/knowledge-images/46038ba600fd.png)
...
![系统管理 -> 菜单管理](/knowledge-images/f08bc75f0f72.png)

菜单可在 [系统管理 -> 角色管理] 被分配给角色。如下图所示：

![系统管理 -> 角色管理](/knowledge-images/237a1cf9b02d.png)

###  3.1 新增目录

① 大多数情况下，目录是作为菜单的【分类】：

![新增目录 —— 菜单的分类](/knowledge-images/cdc83b1ce10b.png)

② 目录也提供实现【外链】的能力：

![新增目录 —— 外链](/knowledge-images/2770f4c2888c.png)

###  3.2 新增菜单

![新增菜单](/knowledge-images/1f21fb3e7ffc.png)

###  3.3 新增按钮

![新增按钮](/knowledge-images/1a11b8002ade.png)
...
![示例](/knowledge-images/89d65de1405c.png)
