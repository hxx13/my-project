...
![EasyExcel](/knowledge-images/74cceeedaae5.png)

##  1. Excel 导出

以 [系统管理 -> 岗位管理] 菜单为例子，讲解它 Excel 导出的实现。

![系统管理 -> 岗位管理](/knowledge-images/49990c321f94.png)
...
![PostExcelVO 效果](/knowledge-images/2cefa7a4a327.png)
...
![write 方法](/knowledge-images/176ff1478c80.png)
...
![handleExport 方法](/knowledge-images/1b787115b4e7.png)

##  2. Excel 导入

以 [系统管理 -> 用户管理] 菜单为例子，讲解它 Excel 导出的实现。

![系统管理 -> 用户管理](/knowledge-images/9ecb41cf2605.png)
...
![导入 Excel 接口](/knowledge-images/d7ac6b7ebc73.png)
...
![UserImportExcelVO 代码](/knowledge-images/576c6202afc9.png)

对应使用的 Excel 导入文件如下：

![UserImportExcelVO 文件](/knowledge-images/4feba38ffe44.png)
...
![read 方法](/knowledge-images/dc045bea20de.png)
...
![Excel 导入的功能](/knowledge-images/a4dfb7491f70.png)
...
![DictConvert 实现](/knowledge-images/bbc8a8791737.png)
...
![DictConvert 使用示例](/knowledge-images/e0706e7b1bd1.png)
