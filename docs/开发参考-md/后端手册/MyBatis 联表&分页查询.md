...
![分页案例 01](/knowledge-images/e0d3bfb02337.png)
...
![分页案例 01 的效果](/knowledge-images/c52128aef406.png)

###  1.2 方案二：MyBatis Plus XML

这个是 MyBatis Plus 拓展的使用方式，可以简化只需要写一条 SQL，步骤如下：

![分页案例 02](/knowledge-images/b34d0413089b.png)
...
![分页案例 02 的效果](/knowledge-images/f14510e8337f.png)
