...
![授权模式的选择](/knowledge-images/0fcc941e7082.png)
...
![项目使用的授权模式](/knowledge-images/4495e24db712.png)
...
![整体架构](/knowledge-images/9a184fb5247e.png)
...
![整体流程](/knowledge-images/1dd038b9c457.png)
...
![授权码模式的客户端信息](/knowledge-images/392f5f232012.png)
...
![授权码模式的未登录首页](/knowledge-images/dfb2a5489a7f.png)
...
![同意授权](/knowledge-images/bd1ba8d2b3d2.png)

**⑥ 第六步**，完成授权后，会跳转到接入方的 callback.html 回调页，并在 URL 上可以看到 code 授权码。

![授权码模式的回调跳转](/knowledge-images/53379161bc86.png)
...
![授权码模式的登录后首页](/knowledge-images/bc745493efb1.png)
...
![整体流程](/knowledge-images/977560601424.png)
...
![密码模式的客户端信息](/knowledge-images/34f062f6084d.png)
...
![密码模式的未登录首页](/knowledge-images/c4b3c3ddb65b.png)

![密码模式的未登录首页2](/knowledge-images/0e6eee723e1e.png)

**⑤ 第五步**，点击「登录」按钮，调用 `ruoyi-vue-pro` 项目的后端，获取到 accessToken 访问令牌，完成登录操作。

![密码模式的发起登录.png](/knowledge-images/634f59dbfa85.png)

**⑥ 第六步**，登录完成后，跳转回自己的 index.html 首页，并进一步从 `ruoyi-vue-pro` 项目获取到该用户的昵称等个人信息。后续，你可以执行「修改昵称」、「刷新令牌」、「退出登录」等操作。

![密码模式的登录后首页](/knowledge-images/24bf9e7ee5ae.png)
...
![表结构](/knowledge-images/9a26743edd6a.png)
