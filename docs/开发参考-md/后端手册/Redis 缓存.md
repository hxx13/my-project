...
![Spring Data Redis 配置](/knowledge-images/735137851ae3.png)
...
![YudaoRedisAutoConfiguration 配置类](/knowledge-images/f7e5644388a1.png)

###  1.2 实战案例

以访问令牌 Access Token 的缓存来举例子，讲解项目中是如何使用 Spring Data Redis 框架的。

![Access Token 示例](/knowledge-images/adb9846f4502.png)
...
![OAuth2AccessTokenDO 类](/knowledge-images/fb22c98d5285.png)
...
![RedisKeyConstants 类](/knowledge-images/781385b725e7.png)
...
![OAuth2AccessTokenRedisDAO 类](/knowledge-images/129198186b06.png)
...
![OAuth2TokenServiceImpl 类](/knowledge-images/ac89773683c4.png)
...
![Spring Cache 配置](/knowledge-images/6b25a34004a3.png)
...
![YudaoCacheAutoConfiguration 配置类](/knowledge-images/a059269de91d.png)
...
![RoleServiceImpl](/knowledge-images/9da815e1ec15.png)
...
![getTestDemo 方法](/knowledge-images/a1d7c4a7b270.png)

② 执行 `#updateRole(...)` 或 `#deleteRole(...)` 方法，在更新或者删除 MySQL 数据后，从 Redis 删除缓存。如下图所示：

![getTestDemo 方法](/knowledge-images/a8806acc87c1.png)
...
![过期时间](/knowledge-images/b37daee1cb4d.png)
...
![Redis 监控](/knowledge-images/03fad45ff807.png)
