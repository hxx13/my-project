...
![DATASOURCE 模式](/knowledge-images/54965d02149e.png)
...
![SCHEMA 模式](/knowledge-images/374172d10c39.png)
...
![COLUMN 模式](/knowledge-images/075c78beba62.png)
...
![模式选择](/knowledge-images/ef131c9de45d.png)
...
![新增租户](/knowledge-images/c6b84500a86d.png)

② 点击 [确认] 按钮，完成租户的创建，它会自动创建对应的租户管理员、角色等信息。

![租户的管理员、角色](/knowledge-images/7cbc772a8f26.png)

③ 退出系统，登录刚创建的租户。

![登录界面](/knowledge-images/84a71c02e1b8.png)
...
![ 配置项](/knowledge-images/55573bea843f.png)
...
![ 配置项](/knowledge-images/a0e5b3c8abba.png)
...
![TenantUtils 模拟租户](/knowledge-images/8735625136f8.png)
...
![切换租户](/knowledge-images/6cd4c6ca42c9.png)
