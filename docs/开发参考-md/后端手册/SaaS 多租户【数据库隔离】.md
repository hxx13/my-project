...
![新增数据源](/knowledge-images/9040e4d5633b.png)

然后，手动将如下表拷贝到 `ruoyi-vue-pro` 主库中的如下表，拷贝到 `ruoyi-vue-pro-tenant-a` 库中。如下图所示：

![拷贝表结构到数据源](/knowledge-images/b38764cd20d5.png)
...
![新增租户](/knowledge-images/87c5a88dad29.png)

此时，在 `ruoyi-vue-pro-tenant-a` 库中，可以查询到对应的租户管理员、角色等信息。如下图所示：

![查询用户](/knowledge-images/f444a49c9b9c.png)

③ 退出系统，登录刚创建的租户。

![登录界面](/knowledge-images/3ae1847585a2.png)
...
![主库](/knowledge-images/1d3f33677429.png)

② 对应 `master` 数据源，配置在 `application-{env}.yaml` 配置文件。如下图所示：

![ 数据源](/knowledge-images/b81773bbdfd8.png)
...
![ 注解](/knowledge-images/32b0e787ca06.png)
...
![ 注解](/knowledge-images/e9588a2acb8a.png)
...
![使用示例](/knowledge-images/e703c9da4c0b.png)
