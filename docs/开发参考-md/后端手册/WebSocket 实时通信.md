...
![WebSocket 测试界面](/knowledge-images/8f1d166c9eca.png)
...
![WebSocket 连接](/knowledge-images/8e4b1c6856fa.png)

② 发送 WebSocket 消息，如下图所示：

![WebSocket 发送消息](/knowledge-images/af04b90a7b44.png)

③ 接收 WebSocket 消息。如下图所示：

![WebSocket 接收消息](/knowledge-images/fefcd0e9d0da.png)

###  2.2 方案二：WebSocket + HTTP

![公告通知](/knowledge-images/74bc93238035.png)
...
![公告通知的推送](/knowledge-images/1dd139f06748.png)
...
![NoticeController 推送](/knowledge-images/ddb8b998413e.png)
...
![HTTP 发送消息](/knowledge-images/9c96fea80b56.png)
