...
在 《代码生成【单表】》 文章中，我们已经基于代码生成器，在 `yudao-module-system` 模块中，开发一个【**用户组**】的功能。
...
![生成信息](/knowledge-images/a4c6a04d9d68.png)
...
![预览代码](/knowledge-images/b021ac1cd607.png)
...
![拷贝代码](/knowledge-images/7f7d66e73c5c.png)

② 参考 《前端手册 Admin Uniapp —— 菜单路由》 文档，在 `src/pages/index/index.ts` 的 增加【用户组】菜单。代码如下：

![菜单路由](/knowledge-images/64cef35c7245.png)
