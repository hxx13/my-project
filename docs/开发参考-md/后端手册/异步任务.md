...
![YudaoAsyncAutoConfiguration 配置](/knowledge-images/5e3bddbfd554.png)
...
![ApiAccessLogServiceImpl 类](/knowledge-images/db955c74749b.png)

###  2.3 测试调用

随便请求一个 RESTful API 接口，可以看到在异步任务的线程池中，进行了访问日志的记录。如下图所示：

![IDEA 控制台](/knowledge-images/4a2cae3f0129.png)
