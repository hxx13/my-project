...
![文件配置](/knowledge-images/6f6ab771a90e.png)

② 点击 [新增] 按钮，选择存储器为【S3 对象存储器】，并填写七牛云的配置。如下图：

![S3 对象存储器](/knowledge-images/56f31fde7ff9.png)
...
![测试配置](/knowledge-images/e3404a37fe77.png)

④ 测试通过后，点击该配置所在行的 [主配置] 按钮，设置它为**默认**的配置，后续使用它进行文件的上传。

![测试配置](/knowledge-images/124f05ac376a.png)

###  1.2 上传文件

① 点击 [基础设施 -> 文件管理 -> 文件列表] 菜单，进入文件列表的界面。

![文件列表](/knowledge-images/09dcc2b36461.png)

② 点击 [上传文件] 按钮，选择要上传的文件。

![文件列表](/knowledge-images/9d4b8b3a30ff.png)

③ 上传完成后，如果想要删除，可点击该文件所在行的 [删除] 按钮。

![文件列表](/knowledge-images/578dd981e9a5.png)
...
![后端上传](/knowledge-images/4ac94ef89f37.png)
...
![](/knowledge-images/f0be3e583acf.png)

文件上传的调用的 UML 时序图如下所示：

![](/knowledge-images/b6f7e4ea1645.png)
...
![新增配置](/knowledge-images/014a963fc1c9.png)
