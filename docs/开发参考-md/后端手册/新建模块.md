...
![打开 New Module](/knowledge-images/b5062b790804.png)

② 选择 Maven 类型，选择父模块为 `yudao`，输入名字为 `yudao-module-demo`，并点击 Create 按钮，如下图所示：

![填写 Module 信息](/knowledge-images/525a656f4d30.png)

③ 打开 `yudao-module-demo` 模块，删除 src 和 test 下多余的文件，如下图所示：

![删除多余的文件](/knowledge-images/ef8575ba65b4.png)
...
![引入模块](/knowledge-images/6f1d35b51b3a.png)
...
![测试  接口](/knowledge-images/c250b997df09.png)

② 打开“用户 App - Test”接口，进行 `/app-api/demo/test/get` 接口的调试，如下图所示：

![测试  接口](/knowledge-images/f3367c376076.png)
...
![接口分组](/knowledge-images/6ffacd574c9f.png)

###  5.3 MyBatis 日志

如果你希望新模块的 MyBatis 查询会打印 SQL 日志，需要在 `logging.level` 配置对应的 Logger。如下图所示：

![MyBatis 日志](/knowledge-images/36c9e4244955.png)
