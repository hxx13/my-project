...
![表关系](/knowledge-images/0e665399b1cb.png)
...
![订单状态流转](/knowledge-images/c31799047c31.png)
...
![订单流程](/knowledge-images/a10b8233d2c7.png)

![去结算](/knowledge-images/c57a536e100a.png)

###  2.1 结算【买家】

① 前端对应 `yudao-mall-uniapp` 项目的 `pages/order/confirm.vue` 页面，如下图所示：

![订单结算页](/knowledge-images/93a2fbd7a0b3.png)
...
![TradePriceCalculator 类图](/knowledge-images/a2abb1e7f8c9.png)
...
![TradeOrderHandler 实现类](/knowledge-images/e8bc6c7a4896.png)
...
![订单支付页](/knowledge-images/8de2052d6568.png)
...
![配置文件](/knowledge-images/2938a34c53b4.png)
...
![确认收货](/knowledge-images/ed971953845d.png)
