...
![表关系](/knowledge-images/e35ae7a49c4d.png)
...
![分销用户](/knowledge-images/e7e6946dd491.png)
...
![分销中心](/knowledge-images/a338b2646626.png)

在 [我的团队] 中，可以查看自己的下级分销用户，以及下级分销用户的推广订单，对应 `pages/commission/team.vue` 文件。如下图所示：

![我的团队](/knowledge-images/616b7243ab1b.png)
...
![邀请海报](/knowledge-images/5ba514504a4d.png)
...
![分销关系](/knowledge-images/8e33253f763a.png)
...
![分销商品](/knowledge-images/d3d27b0b56b1.png)
...
![佣金记录](/knowledge-images/bd680374dc62.png)

###  2.3 移动端

在 [分销订单] 中，可以查看自己的分销订单，对应 `pages/commission/order.vue` 文件。如下图所示：

![分销订单](/knowledge-images/90d9c15e1c1d.png)
...
![佣金提现](/knowledge-images/91dd2bf62cd7.png)

###  3.2 移动端

① 在 [佣金明细] 中，可以查看自己的提现记录，对应 `pages/commission/wallet.vue` 文件。如下图所示：

![佣金明细](/knowledge-images/ce29c244f22a.png)

② 点击「提现」按钮，可以申请提现，对应 `pages/commission/withdraw.vue` 文件。如下图所示：

![申请提现](/knowledge-images/5e1970c323ca.png)

##  4. 分佣配置

![分佣配置](/knowledge-images/ec0e03ee9574.png)
