...
![SKU 信息](/knowledge-images/72eedcb02d10.png)
...
![基础设置](/knowledge-images/045fb6b6a0ba.png)
...
![其它设置](/knowledge-images/68ccc7299f14.png)
...
![前端代码](/knowledge-images/b04e554da1ee.png)

###  3.1 商品列表

商品列表，对应 `@/pages/goods/list.vue` 文件。界面效果如下图所示：

![商品列表](/knowledge-images/085a61aea0d8.png)

###  3.2 商品详情

商品详情，对应 `@/pages/goods/index.vue` 文件。界面效果如下图所示：

![商品详情](/knowledge-images/77b9aa80aa24.png)

考虑到商品详情界面的复杂性，所以将其拆分成多个组件，如下图所示：

![商品详情](/knowledge-images/6ae8e10fa834.png)
