...
![评价列表](/knowledge-images/5c816b50487f.png)
...
![商品详情页-评价列表](/knowledge-images/169ed39d508c.png)

② 点击「查看全部」按钮，进入商品评价列表页，由 `yudao-ui-uniapp` 项目的 `pages/goods/comment/list.vue` 实现。如下图所示：

![评价列表](/knowledge-images/43d0014c27b2.png)

###  3.2 添加评价

在订单确认售后后，可以对商品进行评价，由 `yudao-ui-uniapp` 项目的 `pages/goods/comment/add.vue` 实现。如下图所示：

![待评价订单](/knowledge-images/3c033a5a9211.png)

![添加评价](/knowledge-images/cc1f2237e368.png)

【商品】商品 SPU 与 SKU 【交易】购物车
