...
![表关系](/knowledge-images/fa6ae12e22f4.png)
...
- 1、直接领取：展示在 uni-app 的 [首页]、[领劵中心]、[商品详情]，由用户主动领取。如下图所示：
  ![直接领取](/knowledge-images/0a78ccf0cffb.png)
- 2、指定发放：管理员在管理后台，指定用户发放。如下图所示：
  ![指定发放](/knowledge-images/cf7ede34395b.png)
