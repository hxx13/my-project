...
![文章内容](/knowledge-images/1159cddc6fe0.png)
...
![管理后台](/knowledge-images/5799d2ef0971.png)

###  2.3 移动端

目前 uni-app 暂时未使用到，可以忽略。。。

【营销】限时折扣 【统计】会员、商品、交易统计
