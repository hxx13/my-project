...
![表关系](/knowledge-images/d22298082208.png)
...
![管理后台](/knowledge-images/38e3aa4a73b7.png)
...
![商品列表](/knowledge-images/7fbd510acb4e.png)
...
![商品详情](/knowledge-images/1e5c3ecb7507.png)

###  3.2 价格计算

下单时，限时折扣的价格计算，后端由 TradeMemberLevelPriceCalculator 类实现。效果如下图所示：

![下单确认页](/knowledge-images/8446799adae5.png)
