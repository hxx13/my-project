...
![功能图](/knowledge-images/6e5090061132.png)
...
![功能图](/knowledge-images/77d9882fe30d.png)

##  1. 功能介绍

主要拆分四大模块：商品中心、交易中心、营销中心、会员中心。如下图所示：

![功能列表](/knowledge-images/037a2a4747c9.png)
...
![取消  模块的注释](/knowledge-images/5e353cb0a644.png)
...
![引入  模块](/knowledge-images/ed46f233ab1a.png)
...
![确认功能是否生效](/knowledge-images/037a2a4747c9.png)
...
uniapp 中「首页」「我的」界面，是通过店铺装修所实现。如果觉得默认界面不好看，或者不满足你的页面场景，可以参考 《店铺装修》 文档，进行自定义。
...
④ 首页和个人中心的 banner、icon 等图片，参考 《店铺装修》 进行替换。
...
注意，微信有各种白名单要配置，可参考 [https://blog.csdn.net/weixin\_45966674/article/details/133280890](https://blog.csdn.net/weixin_45966674/article/details/133280890) 文章。
