...
![装修模版 - 列表](/knowledge-images/0716e9edfd67.png)

② 点击「装修」后，可以进行首页、个人中心设计。如下图所示：

![装修模版 - 列表](/knowledge-images/508c3fa9804d.png)

###  1.2 装修页面

装修模版，可以简单理解它由两个装修页面组成：首页、个人中心。所以装修页面的「装修」功能，和装修模版是一致的。如下图所示：

![装修页面 - 列表](/knowledge-images/431ac1f158cb.png)
...
![uni-app 自定义页面](/knowledge-images/c31cbdb69398.png)
...
![加载配置](/knowledge-images/c99101826aee.png)
...
![首页展示](/knowledge-images/61cf5a1a0975.png)

例如说，`s-title-block.vue` 它用于“标题栏”的展示。拿到它对应的 `data` 装修配置，就可以进行展示了。如下图所示：

![标题栏](/knowledge-images/6f42c95af261.png)
...
![DiyEditor 组件](/knowledge-images/e12b63219350.png)
...
![装修组件](/knowledge-images/016ca5ab6771.png)
