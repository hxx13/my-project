...
![大屏设计器](/knowledge-images/c23be467ad45.gif)
...
![引入  模块](/knowledge-images/82384d1cab21.png)
...
![引入  依赖](/knowledge-images/af8ed0ef45df.png)
...
![导入 SQL 脚本](/knowledge-images/19099e96d0a6.png)
...
![前端界面](/knowledge-images/f31e45eafb01.png)

③ 访问 [报表管理 -> 大屏设计器] 菜单，可以查看对应的功能。如下图所示：

![前端界面](/knowledge-images/1934b2fe008d.png)
...
![前端界面](/knowledge-images/e7a7a0b8e130.png)
...
![Go-View 使用示例](/knowledge-images/c6d73ce0da3e.png)
