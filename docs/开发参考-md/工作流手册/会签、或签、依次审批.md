...
![或签配置](/knowledge-images/34a400435674.png)
...
![依次审批配置](/knowledge-images/f8eb0da90490.png)
...
![Behavior 类图](/knowledge-images/81347b5f4de6.png)
...
![BpmParallelMultiInstanceBehavior](/knowledge-images/e4bb53d08434.png)

② BpmUserTaskActivityBehavior，判断是多实例的情况，则复用 BpmParallelMultiInstanceBehavior “计算”结果，直接设置审批人。如下图所示：

![BpmUserTaskActivityBehavior](/knowledge-images/89a63b31b366.png)
...
![BpmSequentialMultiInstanceBehavior](/knowledge-images/75838aea8563.png)
