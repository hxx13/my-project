...
![引入  模块](/knowledge-images/c240ea44c4e9.png)
...
![引入  依赖](/knowledge-images/fe627a4eb4a8.png)
...
![导入 ](/knowledge-images/2d04e6cb93b0.png)
...
![管理后台](/knowledge-images/5b409206f421.png)
...
你可以参考 《审批接入（流程表单）》 文档，自己创建一个流程模型，不会很复杂哈。
...
![项目结构](/knowledge-images/8b4850529d8e.png)
