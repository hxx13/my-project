...
![请假单数据库表](/knowledge-images/0e47784bc3c6.png)
...
![后续时序图](/knowledge-images/b3495f4c77ae.png)

具体的实现代码比较简单，如下图所示：

![BpmOALeaveServiceImpl 创建流程的逻辑](/knowledge-images/0dd230fa2582.png)
...
![BpmOALeaveStatusListener 监听结果](/knowledge-images/e722878c6012.png)
...
![新建流程](/knowledge-images/52904a303ecc.png)
...
![设计流程](/knowledge-images/0fce63c08bd8.png)

可以点击 `oa_leave_bpmn.XML` 进行下载，然后点击「打开文件」按钮，进行导入。

② 点击图中的“部门领导审批”，规则类型为“发起人部门负责人”。如下图所示：

![设置审批人 - 领导审批](/knowledge-images/650952e75ac9.png)

③ 点击图中的“HR 审批”，规则类型为“岗位”，指定岗位为“人力资源”。如下图所示：

![设置审批人 - HR 审批](/knowledge-images/35dfc483436c.png)
...
![发布流程](/knowledge-images/3e32d2d19917.png)
...
1. 访问 [工作流程 -> 审批中心 -> 发起流程] 菜单，选择“OA 请求”流程，会跳转到流程模型 `oa_leave` 配置的表单提交路由。
   ![路径一：我的流程 -> 发起流程](/knowledge-images/31972483aa2a.png)
2. 访问 [工作流程 -> OA 示例 -> 请假查询] 菜单，点击「发起请假」按钮。
   ![路径二：请假查询 -> 发起请假](/knowledge-images/c38a44fe8234.png)
