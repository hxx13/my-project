...
![示例流程](/knowledge-images/6149a453b52e.png)
...
![新建表单 - 设计](/knowledge-images/79790706411e.png)

![新建表单 - 保存](/knowledge-images/eebc481b1205.png)
...
![新建流程](/knowledge-images/2d4761de9dfc.png)
...
- 流程类型：支持 BPMN 设计器 和 SIMPLE 设计器 两种。选择 “BPMN 设计器” 即可。
...
![表单设计](/knowledge-images/b5efb3858d2d.png)

####  1.1.3 设计流程

① 切换到「流程设计」选项，在线设计请假流程模型，包含两个用户任务：领导审批、HR 审批。如下图所示：

![设计流程](/knowledge-images/ac72c1e17600.png)

② 点击图中的“部门领导审批”，规则类型为“发起人部门负责人”。如下图所示：

![设置审批人 - 部门领导审批](/knowledge-images/7f4fd3e0476e.png)

③ 点击图中的“HR 审批”，规则类型为“岗位”，指定岗位为“人力资源”。如下图所示：

![设置审批人 - HR 审批](/knowledge-images/3dce9898bcfd.png)
...
![发布流程](/knowledge-images/c5d42f38fb9b.png)
...
![发起流程](/knowledge-images/39cec2b25cf5.png)

② 选择名字为“通用表单”的流程定义，发起请假流程。填写请假表单信息如下：

![填写流程信息](/knowledge-images/62aea666f50c.png)

③ 点击提交成功后，可在 [工作流程 -> 审批中心 -> 我的流程]中，可看到该流程的状态、结果。

![我的流程](/knowledge-images/175757cd881e.png)
...
![待办任务](/knowledge-images/c4d33398a42a.png)

② 点击「办理」按钮，填写审批建议，并点击「通过」按钮，这样任务的审批就完成了。

![部门领导审批](/knowledge-images/0236c71d2480.png)

③ 访问 [工作流程 -> 审批中心 -> 已办任务] 菜单，可以查询到已经审批的任务。

![已办任务](/knowledge-images/127af336fb2a.png)

---

此时，使用【员工】的角色，访问 [工作流程 -> 审批中心 -> 我的流程] 菜单，可以看到流程流转到了【HR 审批】任务。

![部门领导审批后我的流程](/knowledge-images/177f3d075f98.png)
...
![请假流程最终状态](/knowledge-images/42a5cef882c8.png)

##  2. 菜单【流程表单】

本小节，我们单独讲解的是菜单 [工作流程 -> 流程管理 -> 流程表单] 的功能。

![流程表单](/knowledge-images/61060c673367.png)
...
![表单配置](/knowledge-images/4a0bfe7ee194.png)
...
![组件配置](/knowledge-images/6745de23dfc1.png)
...
![流程表单数据存储](/knowledge-images/f9098c55d1ea.png)
