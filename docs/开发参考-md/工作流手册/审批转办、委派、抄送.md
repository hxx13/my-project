...
![转办](/knowledge-images/7b1481e75c72.png)
...
![转办的实现](/knowledge-images/6fcd4a7e8fb9.png)
...
![委派](/knowledge-images/1b4842928b32.png)
...
![委派的实现](/knowledge-images/23c2f2f7e0ec.png)
...
![审批委派的实现](/knowledge-images/b309ba1a5dcf.png)
...
![发起抄送](/knowledge-images/63bf5ce8543d.png)

对应的后端代码，如下图所示：

图片纠错：最新版本不区分 yudao-module-bpm-api 和 yudao-module-bpm-biz 子模块，代码直接合并到 yudao-module-bpm 模块的 src 目录下，更适合单体项目

![发起抄送的实现](/knowledge-images/f8620bc031b9.png)

###  2.3 查看抄送

被抄送人，可以在 [工作流程 -> 审批中心 -> 抄送我的] 菜单，查看到抄送列表，对应界面如下：

![抄送我的](/knowledge-images/81e94875b86b.png)
