...
![执行监听器](/knowledge-images/8f3388ba63e4.png)
...
![DemoDelegateClassExecutionListener](/knowledge-images/7a49f199a8c0.png)

② 在 BPMN 流程图中，配置 Java 类监听器，如下图所示：

![配置监听器](/knowledge-images/6935fc8c2619.png)
...
![DemoDelegateExpressionExecutionListener](/knowledge-images/8c62527d4a9b.png)

并且，需要声明成 Spring Bean！本质上，“委托表达式”是“Java 类”的特例，和 Spring 做了集成。

② 在 BPMN 流程图中，配置委托表达式监听器，如下图所示：

![配置监听器](/knowledge-images/a5738c9342d0.png)
...
![DemoSpringExpressionExecutionListener](/knowledge-images/faaf59e45b2d.png)

② 在 BPMN 流程图中，配置 Spring 表达式监听器，如下图所示：

![配置监听器](/knowledge-images/3c2dc528aad7.png)
...
![DemoDelegateClassTaskListener](/knowledge-images/c8e8fc1fa7fc.png)
...
![DemoDelegateExpressionTaskListener](/knowledge-images/5b2bb1429f14.png)

并且，需要声明成 Spring Bean！本质上，“委托表达式”是“Java 类”的特例，和 Spring 做了集成。

② 在 BPMN 流程图中，配置委托表达式监听器，如下图所示：

![配置监听器](/knowledge-images/ced4f5a3af1f.png)
...
![DemoSpringExpressionTaskListener](/knowledge-images/0eb5af12a7fe.png)

② 在 BPMN 流程图中，配置 Spring 表达式监听器，如下图所示：

![配置监听器](/knowledge-images/5eb471cb06c8.png)
...
![流程监控器](/knowledge-images/0cb8949150e8.png)
...
![选择监听器](/knowledge-images/0dfb78fcf494.png)
