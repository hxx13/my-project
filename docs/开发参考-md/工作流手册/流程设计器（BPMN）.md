...
![示例流程](/knowledge-images/878f4bfee7ab.png)
...
![流程模型](/knowledge-images/5b409206f421.png)
...
![模型的拓展字段](/knowledge-images/11aa3f48b241.png)
...
- （后续）SIMPLE 流程设计器：我们自研，对标钉钉、飞书的流程设计器，适合简单、中等流程设计
...
![流程设计器](/knowledge-images/23c427d76a0e.png)
...
![流程预览](/knowledge-images/7e4150c74f7d.png)
...
![流程设计器的表单配置.png](/knowledge-images/3ed2171ad3bb.png)
...
![流程设计器的表单效果.png](/knowledge-images/7e76fdb92473.png)

填写的表单数据，会存储到 Flowable 任务的 `variables` 中，如下图所示：

![流程设计器的表单数据](/knowledge-images/7d34b270a62f.png)
...
![会签配置](/knowledge-images/9bf532bcc082.png)
...
- 审批类型、审批人拒绝超时时、审批人为空时：
  ![自定义配置](/knowledge-images/56291e18de25.png)
- 审批人与提交人为同一人时、操作按钮：
  ![自定义配置](/knowledge-images/9f68ba8ae6e5.png)
- 字段权限、是否需要签名、审批意见：
  ![自定义配置](/knowledge-images/12ce8c98c1b0.png)
...
![BpmTaskAssignStartUserExpressionConfig](/knowledge-images/069acba26047.png)

详细见 《执行监听器、任务监听器》 文档。

###  1.8 任务监听器

![配置监听器](/knowledge-images/59f402272990.png)

详细见 《执行监听器、任务监听器》 文档。

###  1.9 更多设置

![更多设置](/knowledge-images/889e3c3d7d05.png)

####  1.9.1 流程编码

![流程编码](/knowledge-images/7880410d67e7.png)

####  1.9.2 自定义打印模版

![自定义打印模版](/knowledge-images/f2edb8335cdf.png)

##  2. 流程定义

流程模型在部署后，会创建一个新版本的流程定义，并挂起老版本的流程定义。最终，我们点击某个流程模型的「流程定义」按钮，可以看到它对应的流程定义，如下图所示：

![流程定义](/knowledge-images/7fda49184484.png)
