...
![钱包余额](/knowledge-images/b2bc5fe2587e.png)
...
![修改余额](/knowledge-images/2613b359c587.png)
...
![钱包流水](/knowledge-images/984dc03d4bc9.png)
...
![充值套餐](/knowledge-images/18b70b6470c9.png)
...
![钱包充值开启](/knowledge-images/98adff33bc85.png)

一般情况下，需要将钱包的支付宝、微信等支付渠道也进行配置。这里，我们为了演示方便，直接使用上图的“模拟支付”。

另外，钱包也有对应的的支付、退款回调地址，如下图所示：

![钱包充值回调](/knowledge-images/92be497f4e13.png)
...
![钱包充值发起](/knowledge-images/3d414c46dddc.png)
...
![充值记录](/knowledge-images/2581a152e607.png)
...
![钱包支付](/knowledge-images/20a22112ff1c.png)

###  3.1 钱包支付

在商城 uni-app 收银台，选择“余额支付”时，内部会调用 WalletPayClient 的 `#doUnifiedOrder(...)` 方法，发起支付。

![钱包支付2](/knowledge-images/0bf3269c385a.png)
