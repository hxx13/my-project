...
![整体流程](/knowledge-images/630973d05651.png)
...
![表结构](/knowledge-images/6cd83c0eb4ce.png)
...
![短信渠道的列表](/knowledge-images/a8fa2309cc2a.png)

② 点击 [新增] 按钮，选择渠道编码为【调试（钉钉）】，并填写信息如下图：

![短信渠道的新增](/knowledge-images/6e06a77a67d6.png)
...
![短信模板的新增](/knowledge-images/1c83df15ce35.png)

② 点击 [新增] 按钮，选择刚创建的短信渠道，并填写信息如下图：

![短信模板的新增](/knowledge-images/9a1e7e1a27e5.png)
...
![测试短信模板](/knowledge-images/015942e856a4.png)

![测试短信模板](/knowledge-images/f3d2c48a15e3.png)

友情提示：如果使用的短信渠道是阿里云、腾讯云等正式的短信平台，则会发送到填写的手机号中。例如说：

![接收示例](/knowledge-images/b4988c723422.png)

③ 点击 [系统管理 -> 消息中心 -> 短信管理 -> 短信日志] 采单，可以查看到每条短信的发送状态、接收状态。如下图所示：

![短信日志](/knowledge-images/3e23ba4f7a97.png)
...
![短信发送](/knowledge-images/c463d57b6e98.png)
...
![ 依赖](/knowledge-images/4d07dd6f99f0.png)

② 新建对应的短信模板，如下图所示：

![新建短信模板](/knowledge-images/8a1046d97f9b.png)

③ 使用 Spring 注入 SmsSendApi Bean，调用对应的短信发送方法。如下图所示：

![调用 SmsSendApi 方法](/knowledge-images/6d0cf9cbdd77.png)
...
![ 配置项](/knowledge-images/33a191b56080.png)
...
![ 依赖](/knowledge-images/eb9d04d5f055.png)

② 新建对应的短信模板，如下图所示：

![新建短信模板](/knowledge-images/96ba8a502dff.png)
...
![SmsSceneEnum 枚举](/knowledge-images/3d38dc35fc23.png)

④ 使用 Spring 注入 SmsCodeApi Bean，调用对应的短信验证码的发送与使用方法。如下图所示：

![调用 SmsCodeApi 方法](/knowledge-images/22403d977317.png)
...
![SmsClient 接口](/knowledge-images/256b41e69b02.png)

每个短信平台，都对应一个 SmsClient 实现类。

![SmsClient 实现](/knowledge-images/086a07c7b5a4.png)
...
![SmsClientFactoryImpl 创建客户端](/knowledge-images/892b8e44fdf9.png)
