...
![IDEA 配置热加载](/knowledge-images/c0c64e6fe387.png)
...
![IDEA 代码热加载](/knowledge-images/df5b9e3f8f07.png)
...
![JRebel 下载](/knowledge-images/88fdb229162a.png)

② 打开 [Preference -> Plugins] 菜单，点击「Install Plugin from Disk...」按钮，选择刚下载的 JRebel 插件的压缩包。如下图所示：

![JRebel 安装](/knowledge-images/608ab4859310.png)
...
![JRebel 激活](/knowledge-images/dff26d0ba2b9.png)

之后，点击「Work Offline」按钮，设置 JRebel 为离线，避免因为网络问题导致激活失效。如下图所示：

![JRebel 离线](/knowledge-images/42090e53026e.png)
...
![JRebel 启动项目](/knowledge-images/ffd284699315.png)

② 每次修改 Java 代码后，点击左下角的「热加载」按钮，即可实现代码热加载。如下图所示：

图片纠错：最新版本不区分 yudao-module-system-api 和 yudao-module-system-biz 子模块，代码直接合并到 yudao-module-system 模块的 src 目录下，更适合单体项目

![JRebel 代码热加载](/knowledge-images/f6ae6d01c76e.png)
