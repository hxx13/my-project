...
![新建模式](/knowledge-images/d88f066f0c62.png)
...
![数据库依赖](/knowledge-images/bb2e16a2e84e.png)

② 修改 `application-local.yaml` 配置文件，将数据库的 `url`、`username`、`password` 修改为 DM 数据库。例如说：

![数据库连接配置](/knowledge-images/3ece96eedc72.png)
...
![连接大金数据库](/knowledge-images/7cd95ed9397d.png)
...
![数据库连接配置](/knowledge-images/8d980902721e.png)
...
![数据库连接配置](/knowledge-images/3064e1badaf7.png)
