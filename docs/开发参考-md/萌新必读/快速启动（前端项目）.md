...
![前端界面](/knowledge-images/54e6592c9465.webp)
...
参考 《快速启动【后端】》 文档，启动起来非常容易！未来可能是 AI + 全栈！
...
![前端界面](/knowledge-images/7c3c49ee18fa.png)
...
![启动前端项目](/knowledge-images/a1d937dfce63.webp)

② 启动完成后，浏览器会自动打开 [http://localhost:1024](http://localhost:1024) 地址，可以看到前端界面。

![前端界面](/knowledge-images/fd60f55887bb.webp)
...
![前端界面](/knowledge-images/371350af7812.png)
...
![配置 ](/knowledge-images/a3e7ac272ce2.png)
...
![微信小程序界面](/knowledge-images/82ea9ef777a3.png)

如果出现请求后端失败，需要把勾选上“不校验合法域名、web-view(业务域名)、tls 版本以及 https 证书”！！！

另外，如果你要体验微信小程序登录，可参考 《微信小程序登录》 文档进行配置。
