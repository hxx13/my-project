...
![Star 一波](/knowledge-images/d7106afc4046.png)
...
![导入 MySQL 数据库](/knowledge-images/e9662bba32c3.png)

② 默认配置下，MySQL 需要启动在 3306 端口，并且账号是 root，密码是 123456。如果不一致，需要修改 `application-local.yaml` 配置文件。

![修改配置文件](/knowledge-images/ddee9ec02d75.webp)
...
![修改配置文件](/knowledge-images/8ff37d21278e.webp)

友情提示：

如果你的项目不希望使用 Redis，可以参考文档 《如何去除 Redis 缓存》。
...
![后端编译](/knowledge-images/49d2bd36f976.png)
...
![启动后端项目](/knowledge-images/04dafe5f02bb.webp)
...
![“Command line is too long” 错误](/knowledge-images/e91d3417dfe8.png)
...
![演示项目](/knowledge-images/e34773535ee8.png)
