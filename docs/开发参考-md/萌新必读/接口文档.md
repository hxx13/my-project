...
![Apifox 下载](/knowledge-images/0026be11d464.png)

解压后，双击进行安装即可。黑色界面，非常酷炫。

![Apifox 界面](/knowledge-images/aa5076a2f634.png)

###  1.2 API 导入

① 先点击「示例项目」，再点击「+」按钮，选择「导入」选项。

![Apifox 界面 —— 导入](/knowledge-images/b7f0d6c92209.png)

② 先选择「URL 导入」按钮，填写 Swagger 数据 URL 为 `http://127.0.0.1:48081/v3/api-docs` 。如果失败，则可以尝试 `http://127.0.0.1:48080/v3/api-docs/all` 解决。

![Apifox 界面 —— Swagger](/knowledge-images/aa694e5e8175.png)

③ 先点击「提交」按钮，再点击「确认导入」按钮，完成 API 接口的导入。

![Apifox 界面 —— Swagger](/knowledge-images/2a4ed52ccc4f.png)

④ 导入完成后，点击「接口管理」按钮，可以查看到 API 列表。

![Apifox 界面 —— 接口管理](/knowledge-images/91ef8409084a.png)

###  1.3 API 调试

① 先点击右上角「请选择环境」，再点击「管理环境」选项，填写测试环境的地址为 `http://127.0.0.1:48080`，并进行保存。

![Apifox 界面 —— 管理环境](/knowledge-images/c0373ed498b5.png)

② 点击「管理后台 —— 认证」的「使用账号密码登录」接口，查看该 API 接口的定义。

![Apifox 界面 —— 认证](/knowledge-images/a9cf2048b62f.png)

③ 点击「运行」按钮，填写 Headers 的 `tenant-id` 为 1，再点击 Body 的「自动生成」按钮，最后点击「发送」按钮。

![Apifox 界面 —— 认证](/knowledge-images/eee9ad862a9e.png)
...
![Apifox 常见问题 1](/knowledge-images/784c7c60e485.png)
...
![Knife4j 界面](/knowledge-images/5dc66691fd61.png)
...
![Knife4j 调试](/knowledge-images/d14121bd1e41.png)
...
![Swagger 关闭](/knowledge-images/6a22af4ba20b.png)
