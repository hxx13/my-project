...
![Navicat](/knowledge-images/d9411d908bf0.png)
...
![数据同步](/knowledge-images/2b7df5accc7d.png)
...
删除功能（以租户为例） 国产信创数据库（DM 达梦、大金、OpenGauss）
