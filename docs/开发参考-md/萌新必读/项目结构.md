...
![项目结构](/knowledge-images/4e9af60a14b2.png)
...
![ 示例](/knowledge-images/fc852e79fc40.png)
...
![后端模块结构](/knowledge-images/27a02d20665c.png)

总结来说，每个模块采用**三层**架构 + **非严格**分层，如下图所示：

![项目分层](/knowledge-images/a8eb4341b2c8.png)

下面，我们来看看每个分层（包）的具体结构。

####  3.2 Controller 包

![后端 Controller 结构](/knowledge-images/5ff8b58ce16c.png)
...
![后端 Service 结构](/knowledge-images/8ecc02bb9703.png)
...
![后端 DAL 结构](/knowledge-images/b54cb7cdb871.png)
...
![后端API1](/knowledge-images/8e77ef4e7050.png)
...
![后端API2](/knowledge-images/dae80ccc2175.png)
...
![ 项目](/knowledge-images/2a19c83eca2c.webp)
