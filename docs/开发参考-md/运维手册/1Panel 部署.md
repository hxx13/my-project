...
![Docker 部署](/knowledge-images/5753341cc437.png)
...
![1Panel 首页](/knowledge-images/e4bc5397851a.png)
...
![安装 MySQL](/knowledge-images/f82641989823.png)

####  第二步，导入 SQL 脚本

① 点击 [数据库] 菜单，选择 [MySQL] 标签，再点击 [创建数据库] 按钮，创建一个名字为 `ruoyi-vue-pro` 数据库，。如下图所示：

![新建数据库](/knowledge-images/18494105b9fc.png)
...
![导入 SQL](/knowledge-images/d494e1155bf7.png)
...
![安装 Redis](/knowledge-images/5a39ce37f34e.png)
...
![安装 Nginx](/knowledge-images/3395dedfd253.png)
...
![上传 Jar 包](/knowledge-images/526fbcefebab.png)
...
![添加 Java 项目](/knowledge-images/3aefb54cfb8b.png)

② 后续，可以点击该项目的 [日志] 按钮，进行日志管理。如下图所示：

![Java 项目设置](/knowledge-images/37ee366aa4db.png)
...
![ 配置文件](/knowledge-images/56d879dde3bc.png)
...
![编译前端](/knowledge-images/c00165a294db.png)
...
![ 配置文件](/knowledge-images/7ba726056135.png)

####  第二步，编译前端

在前端项目的根目录下，执行 `npm run build:dev` 命令，编译前端项目，构建出它的 `dist` 文件，里面是 HTML、CSS、JavaScript 等静态文件。如下图所示：

![编译前端](/knowledge-images/7bc60562ce63.png)
...
![ 参数](/knowledge-images/fd328814e002.png)
...
![后端转发](/knowledge-images/01ed20d30628.png)
...
![前端界面](/knowledge-images/065118ebf892.png)
...
![添加 HTML 项目](/knowledge-images/3cdfe76f998f.png)
...
![前端转发](/knowledge-images/9ce6da017a8a.png)
...
![添加 Java 项目](/knowledge-images/8864ec11fda6.png)

【可选：等跑通在走这步骤】② 点击该网站的 [配置] 按钮，选中 [配置文件] 选项，进行 `/admin-api/` 和 `/app-api/` 的转发配置。如下图所示：

![后端转发](/knowledge-images/e044a07f00b5.png)
...
![前端界面](/knowledge-images/f45414279178.png)
