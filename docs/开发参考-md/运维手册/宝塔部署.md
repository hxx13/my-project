...
另外，如果你在部署过程中碰到问题，也可以参考 [https://articles.zsxq.com/id\_xu72z2zjekbx.html](https://articles.zsxq.com/id_xu72z2zjekbx.html) 文章，来自球友的宝塔部署。
...
![宝塔首页](/knowledge-images/527f81f4c39e.png)
...
![安装 Redis](/knowledge-images/10f3a6f0e602.png)
...
![安装 JDK](/knowledge-images/445f26d1abe0.png)
...
![安装 Nginx](/knowledge-images/607ef4317c4e.png)
...
![上传 Jar 包](/knowledge-images/7861de5bf7d2.png)
...
![添加 Java 项目](/knowledge-images/6ae716aaa85d.png)

② 后续，可以点击该项目的 [设置] 按钮，进行日志管理、性能监控、负载状态、配置文件等等。如下图所示：

![Java 项目设置](/knowledge-images/5b55964d75c3.png)
...
![上传  文件](/knowledge-images/a6b34ddca68e.png)
...
![上传  文件](/knowledge-images/bfd9cf0aa12d.png)
...
![上传  文件](/knowledge-images/7265d2d845f2.png)
...
![添加 HTML 项目](/knowledge-images/65b55df952f0.png)
...
![后端转发](/knowledge-images/bfda946d6e14.png)
...
![添加 HTML 项目](/knowledge-images/a2d91a18a162.png)
...
![前端转发](/knowledge-images/f601d7427941.png)

####  第二步，配置后端转发

① 点击 Java 项目的 [设置] 按钮，选中 [域名管理] 选项，在“域名”输入后端的域名，如 `api.iocoder.cn`。如下图所示：

![域名管理](/knowledge-images/0961ca227a9c.png)

② 选中 [外网访问] 选项，把“外网映射”选上。如下图所示：

![外网映射](/knowledge-images/c111ac732165.png)

③ 选中 [配置文件] 选项，选择 [伪静态配置文件] 选项，进行后端的转发配置。如下图所示：

![后端转发](/knowledge-images/2c1b2b9dd18c.png)
