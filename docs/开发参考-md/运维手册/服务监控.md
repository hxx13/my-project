...
![应用 - 列表](/knowledge-images/2f027a37c65e.png)

② 点击 `yudao-server` 应用，再点击实例，可以查看到该实例的细节信息。如下图所示：

![应用 - 明细](/knowledge-images/bdfe70337f28.png)

③ 点击 [日志 -> 日志文件] 菜单，查看该示例的日志内容。如下图所示：

![应用 - 日志](/knowledge-images/cf68116be674.png)

点击 [日志 -> 日志文件] 菜单，可动态修改 Logger 的日志级别，方便排查线上的某些 BUG。如下图所示：

![应用 - 日志](/knowledge-images/4ec50d3ca5fd.png)
...
![ 配置](/knowledge-images/aa8f59260a9b.png)
...
![ 文件](/knowledge-images/6cdd4a3eb1df.png)

###  2.2 如何使用？

① 点击 [基础设施 -> 监控中心 -> 链路追踪] 菜单，可以看到 SkyWalking 提供的链路追踪。如下图所示：

![基础设施 -> 链路追踪](/knowledge-images/4797d4659553.png)

② 点击 `yudao-server` 服务，查看该服务的监控信息。如下图所示：

![ 服务](/knowledge-images/2612bca55754.png)
