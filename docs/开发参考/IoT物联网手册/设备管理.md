...
详见 [《设备网关与子设备》](/开发参考/IoT物联网手册/设备网关与子设备.md)。
...
详见 [《OTA 固件升级》](/开发参考/IoT物联网手册/OTA 固件升级.md)。
...
详细可见 [《设备网关与子设备》](/开发参考/IoT物联网手册/设备网关与子设备.md)。
...
详细可见 [《设备接入（Modbus Client 模式）》](/开发参考/IoT物联网手册/设备接入（Modbus Client 模式）.md) 和 [《设备接入（Modbus Server 模式）》](/开发参考/IoT物联网手册/设备接入（Modbus Server 模式）.md)。
