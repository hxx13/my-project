...
**不涉及**：采购订单 / 销售订单 / 应收应付 / 财务结算 / 生产工单 / 工序工艺 / 质检 / 设备 / 工具 / 排班；也**不涉及**库区库位、批次、生产日期、过期日期、SN 一物一码（详见 《功能开启》）。

详见 [《WMS 演示》](/开发参考/WMS手册/WMS 演示.md)。
...
详见 [《MES 手册》](/开发参考/MES手册/MES 演示.md)。
...
详见 [《ERP 手册》](/开发参考/ERP手册/ERP 演示.md)。
...
-   选 WMS：参考 《功能开启》，3 分钟开起来；后续按 [《WMS 演示》](/开发参考/WMS手册/WMS 演示.md) 的 5 节表结构按需读模块文档。
