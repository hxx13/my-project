...
③ 【会员等级】`level_id` 字段，是用户的 VIP 等级编号。`experience` 字段，是用户的经验值。相关的内容，可见 [《会员等级、积分、签到》](/开发参考/会员手册/会员等级、积分、签到.md) 文档。

④ 【会员积分】`point` 字段，是用户的积分。相关的内容，可见 [《会员等级、积分、签到》](/开发参考/会员手册/会员等级、积分、签到.md) 文档。
...
① 会员登录，可见 [《微信公众号登录》](/开发参考/会员手册/微信公众号登录.md)、[《微信小程序登录》](/开发参考/会员手册/微信小程序登录.md) 文档。
