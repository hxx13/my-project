  ...
  return (
    <label
      className={cn(
        ...
        "hover:border-[var(--app-color-border-strong)] hover:bg-[var(--app-color-surface-hover)] focus-within:ring-[3px] focus-within:ring-[color:color-mix(in_srgb,var(--admin-focus-ring)_40%,transparent)] active:translate-y-px",
