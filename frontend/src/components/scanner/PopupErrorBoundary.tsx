    ...
    render() {
        ...
        return (
            <div {...SCAN_MODAL_LAYER_PROPS} className={`fixed inset-0 z-[var(--z-modal)] flex items-center justify-center ${SCAN_POPUP_BACKDROP}`}>
                ...
                <div className="w-[520px] max-w-[90vw] rounded-[var(--app-radius-container)] border border-[color-mix(in_srgb,var(--app-color-feedback-danger)_40%,transparent)] bg-[var(--app-color-surface-container)] p-6 text-[var(--app-color-text-primary)] shadow-[var(--app-elevation-modal)]">
