...
export function UiverseProfilePopup(props: PopupProps & { swipeWarning?: string | null; swipeWarningKey?: number; swipeBlockedUntil?: number }) {
    const { result, onClose, autoActionRoomId = "", executeErrorMessage, onOpenStudentBind, swipeWarning, swipeWarningKey, swipeBlockedUntil } = props;
