...
export type ThemeAnimatedSwitchProps = {
    checked: boolean;
...
const SIZE_TO_TOGGLE: Record<NonNullable<ThemeAnimatedSwitchProps["size"]>, string> = {
    xs: "12px",
    sm: "18px",
    md: "30px",
};

export function ThemeAnimatedSwitch({
    checked,
    onCheckedChange,
    disabled = false,
    ...
    return (
        <StyledWrapper $toggleSize={SIZE_TO_TOGGLE[size]} className={cn("shrink-0", className)}>
            <label
                ...
                <div className="theme-switch__container" aria-hidden="true">
                    ...
                    <div className="theme-switch__stars-container">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144 55" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd" d={STARS_SVG_PATH} fill="currentColor" />
                        </svg>
                    </div>
...
const StyledWrapper = styled.div<{ $toggleSize: string }>`
    .theme-switch {
        --toggle-size: ${({ $toggleSize }) => $toggleSize};
    ...
    .theme-switch[data-disabled="true"] {
        opacity: 0.55;
        pointer-events: none;
    }
    ...
    .theme-switch__checkbox:disabled {
        cursor: not-allowed;
    }
