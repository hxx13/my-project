  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        sidebarVisible: (ctx) => ctx.flags.canViewSettings && show(ctx, "/admin/push-dashboard", "ADMIN"),
      },
      {
        id: "push-config",
    ...
    items: [
      {
        ...
        sidebarVisible: (ctx) => hasMinRole(ctx.role, "SUPER_ADMIN") && show(ctx, "/admin/conversation-archive", "SUPER_ADMIN"),
      },
    ],
  },
];
