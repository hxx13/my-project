    ...
    items: [
      {
        ...
        label: "定时管理",
        icon: CalendarClock,
        homeTone: "from-blue-500 to-indigo-600",
        fallbackMinRole: "ADMIN",
      ...
      },
      {
        ...
        homeTone: "from-slate-500 to-zinc-600",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        label: "接口中心",
        icon: BookOpen,
        homeTone: "from-green-500 to-emerald-600",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        label: "登录页轮播图",
        icon: Images,
        homeTone: "from-fuchsia-500 to-pink-600",
        fallbackMinRole: "SUPER_ADMIN",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        homeTone: "from-amber-500 to-orange-600",
        fallbackMinRole: "STAFF",
