    ...
    items: [
      {
        ...
        label: "消息与通讯录",
        icon: MessagesSquare,
        homeTone: "from-violet-300 to-fuchsia-400",
    ...
    items: [
      {
        ...
        homeTone: "from-indigo-300 to-blue-400",
      ...
      },
      {
        ...
        label: "消息通知",
        icon: Bell,
        homeTone: "from-violet-200 to-purple-300",
        fallbackMinRole: "STAFF",
      ...
      },
      {
        ...
        label: "警告与弹窗公告",
        icon: AlertTriangle,
        homeTone: "from-amber-300 to-orange-400",
      ...
      },
      {
        ...
        label: "小程序内容中心",
        icon: Megaphone,
        homeTone: "from-violet-300 to-indigo-300",
        fallbackMinRole: "ADMIN",
    ...
    items: [
      {
        ...
        label: "定时管理",
        icon: CalendarClock,
        homeTone: "from-blue-200 to-indigo-300",
        fallbackMinRole: "ADMIN",
      ...
      },
      {
        ...
        homeTone: "from-slate-200 to-zinc-300",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        label: "日志控制台",
        icon: Terminal,
        homeTone: "from-emerald-200 to-green-300",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        label: "外部通信配置",
        icon: Link2,
        homeTone: "from-cyan-200 to-blue-300",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        label: "接口中心",
        icon: BookOpen,
        homeTone: "from-green-200 to-emerald-300",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        label: "页面权限设置",
        icon: KeyRound,
        homeTone: "from-rose-300 to-pink-400",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        homeTone: "from-indigo-300 to-violet-400",
        fallbackMinRole: "STAFF",
      ...
      },
      {
        ...
        label: "登录页轮播图",
        icon: Images,
        homeTone: "from-fuchsia-300 to-pink-300",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        label: "注册推荐码",
        icon: Ticket,
        homeTone: "from-amber-200 to-orange-300",
        fallbackMinRole: "ADMIN",
    ...
    items: [
      {
        ...
        label: "大华发卡",
        icon: CreditCard,
        homeTone: "from-sky-200 to-indigo-300",
        fallbackMinRole: "ADMIN",
      ...
      },
      {
        ...
        homeTone: "from-emerald-300 to-green-400",
        fallbackMinRole: "SUPER_ADMIN",
      ...
      },
      {
        ...
        label: "门禁规则配置",
        icon: LockKeyhole,
        homeTone: "from-red-300 to-rose-300",
        fallbackMinRole: "ADMIN",
      ...
      },
      {
        ...
        homeTone: "from-blue-300 to-indigo-400",
        fallbackMinRole: "ADMIN",
      ...
      },
      {
        ...
        label: "门禁联动规则",
        icon: ShieldAlert,
        homeTone: "from-purple-200 to-indigo-300",
        fallbackMinRole: "ADMIN",
      ...
      },
      {
        ...
        label: "自动化日志",
        icon: FileText,
        homeTone: "from-violet-300 to-indigo-400",
        fallbackMinRole: "STAFF",
      ...
      },
      {
        ...
        label: "温湿度数据归档",
        icon: Archive,
        homeTone: "from-teal-200 to-cyan-300",
        fallbackMinRole: "ADMIN",
      ...
      },
      {
        ...
        label: "动物房驾驶舱",
        icon: BarChart3,
        homeTone: "from-cyan-300 to-indigo-400",
        fallbackMinRole: "ADMIN",
        telemetry: true,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "ARO房间",
        icon: MapPin,
        homeTone: "from-fuchsia-300 to-violet-300",
        fallbackMinRole: "ADMIN",
    ...
    items: [
      {
        ...
        label: "检查维护",
        icon: Activity,
        homeTone: "from-emerald-200 to-teal-300",
        fallbackMinRole: "STAFF",
        ...
        items: [
          {
            ...
            label: "报修申请",
            icon: Wrench,
            homeTone: "from-orange-200 to-amber-300",
            fallbackMinRole: "STAFF",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: "采购处理",
            icon: CircleCheck,
            homeTone: "from-lime-200 to-green-300",
            fallbackMinRole: "SUPER_ADMIN",
        ...
        items: [
          {
            ...
            label: "领用物资",
            icon: Package,
            homeTone: "from-sky-200 to-blue-300",
            fallbackMinRole: "ADMIN",
            navEnd: true,
