                  ...
                  {cols.map((c) => {
                    ...
                    return (
                      <th
                        key={c.code}
                        title={c.code}
                        className={`sticky top-0 z-10 border-b border-[var(--twin-hairline)] bg-[var(--twin-canvas)] px-2.5 py-2 align-bottom font-semibold ${
                  ...
                  <tr key={idt.code} className="odd:bg-[var(--twin-canvas-soft)]">
                    ...
                    {cols.map((c) => {
                      ...
                      return (
                        <td
                          key={c.code}
                          className="border-b border-[var(--twin-hairline)] px-2.5 py-2 text-center"
                        >
                          <button
                            type="button"
                            aria-pressed={on}
