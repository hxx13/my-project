...
import NhpCodelistWorkbench from "@/features/nhp/components/NhpCodelistWorkbench";

/**
 * CageCodelistPage — 笼位字段码表管理（后台控制台壳）。
 *
 * 复用 NHP 码表管理工作台（NhpCodelistWorkbench），挂到控制台页壳下，
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        <NhpCodelistWorkbench onBack={() => navigate("/console/admin/cage-shelves/forms")} />
      </div>
    </div>
  );
}
