...
interface TemplateEditorState {
  ...
  addField: (sectionCode: string, field: FormField) => void;
...
export const useTemplateEditor = create<TemplateEditorState>((set) => ({
  ...
  addField: (sectionCode, field) =>
    set((s) => ({ sections: R.addField(s.sections, sectionCode, field) })),
