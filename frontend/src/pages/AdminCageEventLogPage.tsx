              ...
              <table className="w-full text-xs">
                <thead className="border-b-2 border-[var(--app-color-border-strong)]">
                  <tr className="sticky top-0 z-[2] bg-[var(--app-color-surface-hover)] text-[var(--app-color-text-secondary)] font-bold shadow-[var(--app-elevation-card)]">
                    <th className="p-3 text-left w-[140px]">时间</th>
                    <th className="p-3 text-left w-[80px]">类型</th>
                    <th className="p-3 text-left w-[100px]">笼盒号</th>
                    <th className="p-3 text-left">摘要</th>
                    <th className="p-3 text-left w-[80px]">PI</th>
                    <th className="p-3 text-left">变更前位置</th>
                    <th className="p-3 text-left">变更后位置</th>
                  </tr>
                </thead>
                <tbody>
                  {rows.map((row) => (
