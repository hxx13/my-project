...
INSERT IGNORE INTO twin_access_rule_scan_config (id, enter_dispatch_enabled, exit_dispatch_enabled, enter_unfreeze_enabled, exit_freeze_enabled, updated_by)
VALUES (1, 1, 1, 1, 1, 'system');
