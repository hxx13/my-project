...
public interface CrfVisitMapper {
    ...
    @Insert("INSERT INTO crf_visit (code, name, seq, repeating, planned_days, early_days, late_days, end_days, event_anchor, active) " +
            "VALUES (#{code}, #{name}, #{seq}, #{repeating}, #{plannedDays}, #{earlyDays}, #{lateDays}, #{endDays}, #{eventAnchor}, #{active})")
    ...
    @Update("UPDATE crf_visit SET code = #{code}, name = #{name}, seq = #{seq}, repeating = #{repeating}, " +
