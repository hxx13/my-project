...
/**
 * 冻结跑批执行期间的线程上下文：由 {@link com.example.demo.modules.twin.common.service.JobSchedulerService}
 * 在调用 {@link com.example.demo.modules.twin.common.service.JobExecutionRegistry#execute} 前后设置/清理，
 * 供 {@link com.example.demo.modules.twin.card.service.TwinCardMappingService#executeFreezeReaperTask} 写单人审计日志。
 */
