...
public final class TwinAutomationLogDisplayHelper {
     ...
     *
     * @param jobNames    {@link com.example.demo.modules.twin.common.service.JobExecutionRegistry#jobNameMap()} 返回值，可为 null
    ...
    private static String labelTriggerReason(String v) {
        ...
        return switch (u) {
            ...
            case "SWING_EXIT_DELAY_AUTO_SIGNOUT" -> "倒计时结束，自动签退";
            ...
            case "SWING_EXIT_DELAY_TIMER_STARTED" -> "倒计时开始";
    ...
    private static String labelEventKey(String v) {
        ...
        return switch (u) {
            ...
            case "SCAN_DELAY_GRANTED" -> "延迟申请授予豁免（旧码）";
            case "GATE" -> "门禁闸机验证";
