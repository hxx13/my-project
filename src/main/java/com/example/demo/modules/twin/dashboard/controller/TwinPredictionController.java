...
import com.example.demo.modules.twin.dashboard.service.PredictionDebugAssemblerService;
...
public class TwinPredictionController {
    private static final Logger log = LoggerFactory.getLogger(TwinPredictionController.class);
    ...
    public Result<?> getRoomGroupHeatmap(@RequestParam String roomId) {
        ...
        String fullRoomName = "";
        try { fullRoomName = dashboardMapper.getGroupRoomNameById(roomId); } catch (Exception e) { log.warn("查询房间名称失败: {}", e.getMessage()); }
