...
import com.example.demo.modules.twin.scan.delay.service.ScanDelayAutoApproveService;
...
@RestController
@RequestMapping("/api/v1/twin/scan-delay/auto-approve")
@Tag(name = "延迟免冻结自动审批")
public class ScanDelayAutoApproveController {

    private final ScanDelayAutoApproveService autoApproveService;
    private final AuthContextService authContextService;

    public ScanDelayAutoApproveController(
            ScanDelayAutoApproveService autoApproveService,
