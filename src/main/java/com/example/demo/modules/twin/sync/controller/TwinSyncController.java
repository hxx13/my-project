package com.example.demo.modules.twin.sync.controller;
...
public class TwinSyncController {
    ...
    private static final Logger log = LoggerFactory.getLogger(TwinSyncController.class);
    ...
    public Map<String, Object> syncPersonnel() {
        ...
        try {
            log.info("[前端触发] 开始全量拉取 ARO 官方人员库...");
