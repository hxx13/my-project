-- NHP 团队角色字典（team_id=0=全局内置；团队自定义按 team_id 隔离）。与 common/schema/V20260831__nhp_team_role.sql 同源。
-- 角色既可作为 team_member.role_code 指派给成员，也作为权限矩阵主体控制其能力。
...
INSERT IGNORE INTO team_role (team_id, code, label, sort_order) VALUES
(0, 'OWNER', '负责人', 1),
(0, 'MANAGER', '管理员', 2),
(0, 'MEMBER', '成员', 3),
(0, 'RESEARCHER', '研究员', 4),
